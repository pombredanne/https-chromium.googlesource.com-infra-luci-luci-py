...
def _refresh_BotTaskDimensions_async(now, valid_until_ts, dimensions_flat,
  ...
  if need_db_store:
    logging.debug('Storing new BotTaskDimensions to DB.'
    ...
    logging.debug('Keeping stored BotTaskDimensions.'
                  'bot_id: %s, valid_until_ts: %s',
...
def _refresh_all_BotTaskDimensions_async(now, valid_until_ts, dimensions_flat,
  ...
  """
  logging.debug('_refresh_all_BotTaskDimensions_async: refreshing bots with '
               'dimension_hash: %s, dimensions: %s',
