...
def _assert_task_dimensions_async(task_dimensions, exp_ts):
  ...
  def txn():
    ...
    # requests (one transaction "covers" all next ~2h of requests: they'll see
    ...
    extended_ts = exp_ts + datetime.timedelta(hours=2)
...
def _random_timedelta_mins(a, b):
  ...
  return datetime.timedelta(seconds=random.uniform(a * 60, b * 60))
