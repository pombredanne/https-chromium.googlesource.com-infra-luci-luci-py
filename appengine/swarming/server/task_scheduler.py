...
def schedule_request(request,
  ...
  def _get_task_result_summary_from_task_id(task_id):
  ...
  if request_id:
    ...
    if task_exists:
      return _get_task_result_summary_from_task_id(task_exists.task_id)
  ...
  def txn():
    ...
    if request_id:
      ...
      task_req_id = task_request.TaskRequestID(
          key=task_req_to_id,
          task_id=task_pack.pack_result_summary_key(result_summary.key))
