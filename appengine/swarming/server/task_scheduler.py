...
def _get_task_from_external_scheduler(es_cfg, bot_dimensions):
  ...
  # as such ending with '1' or '2'. When '0' is the trailing number, it refers to
  # the overall TaskResultSummary.
  ...
  # result_summary.try_number is None if there's no try yet.
  try_number = result_summary.try_number or 1
