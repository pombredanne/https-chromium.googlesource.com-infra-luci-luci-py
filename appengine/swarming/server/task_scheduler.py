...
def cancel_tasks(task_ids, conditions, limit, cursor=None, kill_running=False):
  # type: (Sequence[str], Sequence[ndb.Node], int, Optional[str],
  #     Optional[bool]) -> Tuple[str, task_result.TaskResultSummary]
  """
  Raises:
