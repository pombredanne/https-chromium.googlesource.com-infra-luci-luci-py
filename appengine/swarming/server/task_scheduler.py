...
def _cancel_pending_children_tasks(result_summary_key):
  """
  This function cancels children tasks with pending state using TaskQueue.
  """
  result_summary = result_summary_key.get()
...
def bot_update_task(
  ...
  if smry.state not in task_result.State.STATES_RUNNING:
    ...
    _cancel_pending_children_tasks(result_summary_key)
