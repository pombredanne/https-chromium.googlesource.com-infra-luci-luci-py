...
from proto.notifications import notifications_pb2
  ...
  if request.has_build_task:
    if _route_to_go(prod_pct=0, dev_pct=25):
      go_payload = {
        ...
        'type': 'taskspb.BuildbucketNotifyTask',
        'body': json_format.MessageToJson(
          notifications_pb2.BuildbucketNotifyTask(
              task_id = task_id,
              state = result_summary.state,
      ...
      ok = utils.enqueue_task(
        '/internal/tasks/t/buildbucket-notify-go/%s' % task_id,
