...
class TaskSchedulerApiTest(test_env_handlers.AppTestBase):
  ...
  def test_cancel_tasks(self):
    ...
    query = task_result.get_result_summaries_query(start=None,
                                                   ...
                                                   tags=[])
    cursor, results = task_scheduler.cancel_tasks(3, query, kill_running=True)
  ...
  def test_cancel_tasks_skip_running(self):
    ...
    query = task_result.get_result_summaries_query(start=None,
                                                   ...
                                                   state='pending',
                                                   tags=[])
    cursor, results = task_scheduler.cancel_tasks(3, query, kill_running=False)
    self.assertIsNone(cursor)
  ...
  def test_cancel_tasks_conditions(self):
    ...
    cursor, results = task_scheduler.cancel_tasks(5, query, kill_running=False)
    self.assertIsNone(cursor)
    self.assertEqual(len(results), 2)
