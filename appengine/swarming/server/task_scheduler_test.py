...
class TaskSchedulerApiTest(test_env_handlers.AppTestBase):
  ...
  def _task_ran_successfully(self, request_id=None):
  ...
  def test_task_idempotent(self):
    ...
    task_id = self._task_ran_successfully(request_id)
