...
def _bot_update_task(run_result_key, **kwargs):
  return task_scheduler.bot_update_task(
      run_result_key=run_result_key,
      bot_id=kwargs.get('bot_id', 'localhost'),
      cipd_pins=kwargs.get('cipd_pins'),
      output=kwargs.get('output', 'hi'),
      output_chunk_start=kwargs.get('output_chunk_start', 0),
      exit_code=kwargs.get('exit_code'),
      duration=kwargs.get('duration'),
      hard_timeout=kwargs.get('hard_timeout', False),
