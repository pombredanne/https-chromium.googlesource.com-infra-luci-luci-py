...
class TaskResultApiTest(TestCase):
  ...
  def test_cron_update_tags(self):
    ...
    expected = task_result.TagAggregation(
        ...
        tags=[task_result.TagValues(tag=u'authenticated', values=[u'user:mocked@example.com']),
            ...
            task_result.TagValues(tag=u'swarming.pool.template', values=[u'no_config']),
    ...
    self.assertEqual(task_result.TagAggregation.KEY.get(), expected)
