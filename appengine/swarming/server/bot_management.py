...
class _BotCommon(ndb.Model):
  ...
  def to_proto(self, out):
    """Populates a swarming_pb2.Bot with this _BotCommon."""
    ...
    out.task_id = self.task_id if self.task_id else None
...
class BotEvent(_BotCommon):
  ...
  def to_proto(self, out):
    ...
    out.event = e if e else swarming_pb2.BOTEVENTTYPE_UNSPECIFIED
