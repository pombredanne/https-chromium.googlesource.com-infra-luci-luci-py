...
def _insert_bot_with_txn(root_key, event, bot_info):
  ...
  # Advantage is that we make use of the context cache of ndb which means
  # that this bot_root may already be in an in-memory cache.
  # see http://cloud/appengine/docs/legacy/standard/python/ndb/cache
