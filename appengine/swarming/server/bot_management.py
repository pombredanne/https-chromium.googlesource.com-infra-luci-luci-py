...
def bot_event(event_type, bot_id, external_ip, authenticated_as, dimensions,
  ...
  # We always need to save BotInfo (in particular `last_seen_ts`) to keep bot
  # alive in the datastore, but only record BotEvent in case something
  # interesting happens, in particular:
