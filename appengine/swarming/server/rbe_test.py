...
class RBETest(test_case.TestCase):
  ...
  @mock.patch('server.rbe._semi_random_100')
  def test_get_rbe_instance(self, semi_random_100, pool_config):
    pools = {
    ...
    semi_random_100.return_value = 30.0
  ...
  def test_semi_random_100(self):
    for i in range(1000):
      val = rbe._semi_random_100(u'bot-%d' % i)
