...
# not ping in the last N minutes while running a task, it is considered dead.
#
# task_runner.MAX_PACKET_INTERVAL is 30 seconds.
#
# "Temporarily" increase from 2 minutes to 6 minutes, as some task workload is
# so overwhelming on the host that the bot process doesn't get CPU time for
# several minutes.
