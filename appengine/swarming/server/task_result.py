...
def task_bq_run(start, end):
  ...
  while more:
    ...
    pubsub.publish_multi(
        'projects/chromeos-swarming/topic/task_results_run',
        {index: MessageToJson(result)
...
def task_bq_summary(start, end):
  ...
  while more:
    ...
    pubsub.publish_multi(
        'projects/chromeos-swarming/topic/task_results_summary',
        {index: MessageToJson(summary)
