...
class PerformanceStats(ndb.Model):
  ...
  def to_proto(self, out):
    ...
    if self.named_caches_install.duration:
      self.named_caches_install.to_proto(out.setup_overhead.named_caches)
    ...
    if setup_dur:
      out.setup.duration.FromTimedelta(
    ...
    if self.named_caches_uninstall.duration:
      self.named_caches_uninstall.to_proto(out.teardown_overhead.named_caches)
