...
class TaskResultSummary(_TaskResultCommon):
  ...
  # Possible values:
  #   None:  if the task is still pending, has expired of was canceled.
  #   1: if the task was ever assigned to a bot and either currently runs
  #      or has finished or crashed already.
