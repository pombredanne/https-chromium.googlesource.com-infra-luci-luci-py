...
class ExternalSchedulerApiTestBatchMode(test_env_handlers.AppTestBase):
  ...
  def test_notify_request_with_tq_batch_mode(self):
    ...
    external_scheduler.notify_requests(
        self.cfg_foo, [(request, result_summary)], True, False, True)
    external_scheduler.notify_requests(
        self.cfg_foo, [(request, result_summary)], True, False, True)
    external_scheduler.notify_requests(
        self.cfg_hoe, [(request, result_summary)], True, False, True)
  ...
  def test_notify_request_with_tq_batch_mode_false(self):
    ...
    external_scheduler.notify_requests(
        self.cfg_foo, [(request, result_summary)], False, False, True)
    external_scheduler.notify_requests(
        self.cfg_hoe, [(request, result_summary)], False, False, True)
