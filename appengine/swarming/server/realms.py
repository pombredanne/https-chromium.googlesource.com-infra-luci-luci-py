# Idendity Copyright 2020 The LUCI Authors. All rights reserved.
...
def check_pools_create_task(pool, pool_cfg):
  ...
  _check_permission(
      perm,
      pool_cfg.realm,
      is_enforced_permission(perm, pool_cfg),
...
def _check_permission(enum_permission,
  ...
  If it's legacy-compatible,
   It calls the legacy permision check function, and compare the legacy result
