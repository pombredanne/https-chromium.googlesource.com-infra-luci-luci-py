...
def _yield_potential_tasks(bot_id, pool, queues, stats, bot_dims_matcher, deadline):
...
def yield_next_available_task_to_dispatch(bot_id, pool, queues, bot_dims_matcher,
                                          deadline):
