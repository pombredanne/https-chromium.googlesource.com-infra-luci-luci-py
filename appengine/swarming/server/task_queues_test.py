...
class TaskQueuesApiTest(test_env_handlers.AppTestBase):
  ...
  def test_dimensions_to_flat_long_unicode_non_BMP(self):
    ...
    key = u'a' * 64
    # Python considers emojis in the supplemental page to be 2 characters on
    # UTF-16/UCS2 builds and one character on UCS4 build.
  ...
  def test_python_len_non_BMP(self):
    # Here is emojis in the base plane. They are 1 character.
