...
class TaskQueuesApiTest(test_env_handlers.AppTestBase):
  ...
  def test_rebuild_task_cache(self):
    ...
    # BotTaskDimensions ndb.Key to confirm that the inner loops work. There's a
    # limit That requires a few bots.
    ...
    # Intentionally force the code to throttle, otherwise this code path
    # wouldn't be reached with less than 50 bots, which would maek the unit test
    # slow.
