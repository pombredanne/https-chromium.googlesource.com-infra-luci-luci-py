...
class TaskSlice(ndb.Model):
  ...
  # slice is enqueued, it is immediately denied with NO_RESOURCE. This should
  # notmally be set to False so tasks that cannot be serviced to not wait
  # neededlessly until their expiration.
