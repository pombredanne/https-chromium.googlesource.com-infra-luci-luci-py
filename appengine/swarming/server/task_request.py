...
class TaskRequest(ndb.Model):
  ...
  def properties_hash(self):
    ...
    if k:
      # TODO(maruel): Next time a refactoring is done that structurally changes
      # all properties_hash values, remove the ".encode('hex')" below while at
      # it, since this is inefficient.
      #
