...
FILES = (
    ...
    'proto_bot/device_pb2.py',
    'proto_bot/reservation_manager_pb2.py',
    'proto_bot/reservation_manager_pb2_grpc.py',
    'proto_bot/status_pb2.py',
    'proto_bot/task_manager_pb2.py',
    'proto_bot/task_manager_pb2_grpc.py',
    'proto_bot/worker_manager_pb2.py',
    'proto_bot/worker_manager_pb2_grpc.py',
