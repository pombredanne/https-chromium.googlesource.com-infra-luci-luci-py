...
_BOTAUTH = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='preferred', full_name='swarming.BotAuth.preferred', index=0,
