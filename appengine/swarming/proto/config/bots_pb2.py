...
_BOTSCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='trusted_dimensions',
            full_name='swarming.config.BotsCfg.trusted_dimensions',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='bot_group',
            full_name='swarming.config.BotsCfg.bot_group',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_BOTGROUP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='bot_id',
            full_name='swarming.config.BotGroup.bot_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='bot_id_prefix',
            full_name='swarming.config.BotGroup.bot_id_prefix',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='auth',
            full_name='swarming.config.BotGroup.auth',
            index=2,
            number=20,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='owners',
            full_name='swarming.config.BotGroup.owners',
            index=3,
            number=21,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='dimensions',
            full_name='swarming.config.BotGroup.dimensions',
            index=4,
            number=22,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_config_script',
            full_name='swarming.config.BotGroup.bot_config_script',
            index=5,
            number=23,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_config_script_content',
            full_name='swarming.config.BotGroup.bot_config_script_content',
            index=6,
            number=25,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='swarming.config.BotGroup.system_service_account',
            index=7,
            number=24,
            type=9,
            cpp_type=9,
...
_BOTAUTH_GCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='project',
            full_name='swarming.config.BotAuth.GCE.project',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_BOTAUTH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='log_if_failed',
            full_name='swarming.config.BotAuth.log_if_failed',
            index=0,
            number=5,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='require_luci_machine_token',
            full_name='swarming.config.BotAuth.require_luci_machine_token',
            index=1,
            number=1,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='require_service_account',
            full_name='swarming.config.BotAuth.require_service_account',
            index=2,
            number=2,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='require_gce_vm_token',
            full_name='swarming.config.BotAuth.require_gce_vm_token',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='ip_whitelist',
            full_name='swarming.config.BotAuth.ip_whitelist',
            index=4,
            number=3,
            type=9,
            cpp_type=9,
...
BotsCfg = _reflection.GeneratedProtocolMessageType(
    'BotsCfg',
    (_message.Message,),
    dict(
        DESCRIPTOR=_BOTSCFG,
...
BotGroup = _reflection.GeneratedProtocolMessageType(
    'BotGroup',
    (_message.Message,),
    dict(
...
BotAuth = _reflection.GeneratedProtocolMessageType(
    'BotAuth',
    (_message.Message,),
    dict(
        GCE=_reflection.GeneratedProtocolMessageType(
            'GCE',
            (_message.Message,),
            dict(
