...
_POOL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='realms', full_name='swarming.config.Pool.realms', index=9,
...
_POOL.fields_by_name['realms'].message_type = components_dot_auth_dot_proto_dot_realms__pb2._REALMS
