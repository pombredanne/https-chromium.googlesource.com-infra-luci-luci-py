...
_POOL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='realm', full_name='swarming.config.Pool.realm', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enforced_realm_permissions', full_name='swarming.config.Pool.enforced_realm_permissions', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='default_task_realm', full_name='swarming.config.Pool.default_task_realm', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task_completion_pubsub', full_name='swarming.config.Pool.task_completion_pubsub', index=12,
...
_PUBSUB = _descriptor.Descriptor(
  name='PubSub',
  full_name='swarming.config.PubSub',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='topic', full_name='swarming.config.PubSub.topic', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='auth_token', full_name='swarming.config.PubSub.auth_token', index=1,
...
_POOL.fields_by_name['task_completion_pubsub'].message_type = _PUBSUB
...
PubSub = _reflection.GeneratedProtocolMessageType('PubSub', (_message.Message,), {
  'DESCRIPTOR' : _PUBSUB,
  '__module__' : 'proto.config.pools_pb2'
  # @@protoc_insertion_point(class_scope:swarming.config.PubSub)
  })
