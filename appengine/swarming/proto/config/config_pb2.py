...
_SETTINGSCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='swarming.config.SettingsCfg.google_analytics',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='reusable_task_age_secs',
            full_name='swarming.config.SettingsCfg.reusable_task_age_secs',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_death_timeout_secs',
            full_name='swarming.config.SettingsCfg.bot_death_timeout_secs',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='swarming.config.SettingsCfg.enable_ts_monitoring',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='isolate',
            full_name='swarming.config.SettingsCfg.isolate',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='cipd',
            full_name='swarming.config.SettingsCfg.cipd',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='force_bots_to_sleep_and_not_run_task',
            full_name=
            'swarming.config.SettingsCfg.force_bots_to_sleep_and_not_run_task',
            index=6,
            number=8,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='ui_client_id',
            full_name='swarming.config.SettingsCfg.ui_client_id',
            index=7,
            number=9,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='display_server_url_template',
            full_name='swarming.config.SettingsCfg.display_server_url_template',
            index=8,
            number=11,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='max_bot_sleep_time',
            full_name='swarming.config.SettingsCfg.max_bot_sleep_time',
            index=9,
            number=12,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='auth',
            full_name='swarming.config.SettingsCfg.auth',
            index=10,
            number=13,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_isolate_grpc_proxy',
            full_name='swarming.config.SettingsCfg.bot_isolate_grpc_proxy',
            index=11,
            number=14,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_swarming_grpc_proxy',
            full_name='swarming.config.SettingsCfg.bot_swarming_grpc_proxy',
            index=12,
            number=15,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='extra_child_src_csp_url',
            full_name='swarming.config.SettingsCfg.extra_child_src_csp_url',
            index=13,
            number=16,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='use_lifo',
            full_name='swarming.config.SettingsCfg.use_lifo',
            index=14,
            number=17,
            type=8,
            cpp_type=7,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='enable_batch_es_notifications',
            full_name=
            'swarming.config.SettingsCfg.enable_batch_es_notifications',
            index=15,
            number=18,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='resultdb',
            full_name='swarming.config.SettingsCfg.resultdb',
            index=16,
            number=19,
            type=11,
            cpp_type=10,
...
_ISOLATESETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='default_server',
            full_name='swarming.config.IsolateSettings.default_server',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='swarming.config.IsolateSettings.default_namespace',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CIPDPACKAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='package_name',
            full_name='swarming.config.CipdPackage.package_name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='version',
            full_name='swarming.config.CipdPackage.version',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CIPDSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='default_server',
            full_name='swarming.config.CipdSettings.default_server',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='default_client_package',
            full_name='swarming.config.CipdSettings.default_client_package',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_AUTHSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='admins_group',
            full_name='swarming.config.AuthSettings.admins_group',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bot_bootstrap_group',
            full_name='swarming.config.AuthSettings.bot_bootstrap_group',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='privileged_users_group',
            full_name='swarming.config.AuthSettings.privileged_users_group',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='users_group',
            full_name='swarming.config.AuthSettings.users_group',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='view_all_bots_group',
            full_name='swarming.config.AuthSettings.view_all_bots_group',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='view_all_tasks_group',
            full_name='swarming.config.AuthSettings.view_all_tasks_group',
            index=5,
            number=6,
            type=9,
            cpp_type=9,
...
_RESULTDBSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='server',
            full_name='swarming.config.ResultDBSettings.server',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CIPDSETTINGS.fields_by_name[
    'default_client_package'].message_type = _CIPDPACKAGE
...
IsolateSettings = _reflection.GeneratedProtocolMessageType(
    'IsolateSettings',
    (_message.Message,),
    dict(
...
CipdSettings = _reflection.GeneratedProtocolMessageType(
    'CipdSettings',
    (_message.Message,),
    dict(
...
AuthSettings = _reflection.GeneratedProtocolMessageType(
    'AuthSettings',
    (_message.Message,),
    dict(
...
ResultDBSettings = _reflection.GeneratedProtocolMessageType(
    'ResultDBSettings',
    (_message.Message,),
    dict(
