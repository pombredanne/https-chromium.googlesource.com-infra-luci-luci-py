...
_SETTINGSCFG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bot_deployment', full_name='swarming.config.SettingsCfg.bot_deployment', index=17,
...
_TRAFFICMIGRATION_ROUTE = _descriptor.Descriptor(
  name='Route',
  full_name='swarming.config.TrafficMigration.Route',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='swarming.config.TrafficMigration.Route.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='route_to_go_percent', full_name='swarming.config.TrafficMigration.Route.route_to_go_percent', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TRAFFICMIGRATION = _descriptor.Descriptor(
  ...
  nested_types=[_TRAFFICMIGRATION_ROUTE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_BOTDEPLOYMENT_BOTPACKAGE = _descriptor.Descriptor(
  name='BotPackage',
  full_name='swarming.config.BotDeployment.BotPackage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='server', full_name='swarming.config.BotDeployment.BotPackage.server', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pkg', full_name='swarming.config.BotDeployment.BotPackage.pkg', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='version', full_name='swarming.config.BotDeployment.BotPackage.version', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BOTDEPLOYMENT = _descriptor.Descriptor(
  name='BotDeployment',
  full_name='swarming.config.BotDeployment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='stable', full_name='swarming.config.BotDeployment.stable', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='canary', full_name='swarming.config.BotDeployment.canary', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_BOTDEPLOYMENT_BOTPACKAGE, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_SETTINGSCFG.fields_by_name['bot_deployment'].message_type = _BOTDEPLOYMENT
...
_TRAFFICMIGRATION_ROUTE.containing_type = _TRAFFICMIGRATION
_TRAFFICMIGRATION.fields_by_name['routes'].message_type = _TRAFFICMIGRATION_ROUTE
_BOTDEPLOYMENT_BOTPACKAGE.containing_type = _BOTDEPLOYMENT
_BOTDEPLOYMENT.fields_by_name['stable'].message_type = _BOTDEPLOYMENT_BOTPACKAGE
_BOTDEPLOYMENT.fields_by_name['canary'].message_type = _BOTDEPLOYMENT_BOTPACKAGE
...
DESCRIPTOR.message_types_by_name['BotDeployment'] = _BOTDEPLOYMENT
...
TrafficMigration = _reflection.GeneratedProtocolMessageType('TrafficMigration', (_message.Message,), {
  ...
  'Route' : _reflection.GeneratedProtocolMessageType('Route', (_message.Message,), {
    'DESCRIPTOR' : _TRAFFICMIGRATION_ROUTE,
    '__module__' : 'proto.config.config_pb2'
    # @@protoc_insertion_point(class_scope:swarming.config.TrafficMigration.Route)
    })
  ,
...
_sym_db.RegisterMessage(TrafficMigration.Route)

BotDeployment = _reflection.GeneratedProtocolMessageType('BotDeployment', (_message.Message,), {

  'BotPackage' : _reflection.GeneratedProtocolMessageType('BotPackage', (_message.Message,), {
    'DESCRIPTOR' : _BOTDEPLOYMENT_BOTPACKAGE,
    '__module__' : 'proto.config.config_pb2'
    # @@protoc_insertion_point(class_scope:swarming.config.BotDeployment.BotPackage)
    })
  ,
  'DESCRIPTOR' : _BOTDEPLOYMENT,
  '__module__' : 'proto.config.config_pb2'
  # @@protoc_insertion_point(class_scope:swarming.config.BotDeployment)
  })
_sym_db.RegisterMessage(BotDeployment)
_sym_db.RegisterMessage(BotDeployment.BotPackage)
