...
NEEDED_PROTOS = {
    'buildbucket/proto/launcher_pb2.py'
    'buildbucket/proto/common_pb2.py',
    'buildbucket/proto/project_config_pb2.py',
    'buildbucket/proto/backend_pb2.py', 'buildbucket/proto/task_pb2.py',
    'buildbucket/proto/build_pb2.py', 'buildbucket/proto/step_pb2.py',
    'buildbucket/proto/field_option_pb2.py',
    ...
    'resultdb/proto/v1/predicate_pb2.py', 'swarming/proto/api/swarming_pb2.py',
    'common/proto/options_pb2.py'
}
...
def main():
  ...
  for filename in all_files:
    if filename not in NEEDED_PROTOS:
      # print("removing %s" %os.path.join(base_dir_py_protos, filename))
  ...
  try:
    # removing previous protos in api/internal/go/
    shutil.rmtree(os.path.join(base, "api", "internal", "go"))
  except FileNotFoundError:
    # this error arrises if there is no directory. We can continue to make one.
    pass

  # Copying protos from tmp go folder to api/interal/go
  shutil.copytree(src=base_dir_py_protos,
                  dst=os.path.join(base, "api", "internal", "go", "chromium",
                                   "org", "luci"))

  # Removing tmp go folder
  shutil.rmtree(base_dir_py_protos)

  if len(seen) != len(NEEDED_PROTOS):
    print("-------")
