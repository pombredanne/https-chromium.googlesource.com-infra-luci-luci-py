...
_SETTINGSCFG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mp', full_name='swarming.SettingsCfg.mp', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='force_bots_to_sleep_and_not_run_task', full_name='swarming.SettingsCfg.force_bots_to_sleep_and_not_run_task', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ui_client_id', full_name='swarming.SettingsCfg.ui_client_id', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='display_server_url_template', full_name='swarming.SettingsCfg.display_server_url_template', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_bot_sleep_time', full_name='swarming.SettingsCfg.max_bot_sleep_time', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='auth', full_name='swarming.SettingsCfg.auth', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bot_isolate_grpc_proxy', full_name='swarming.SettingsCfg.bot_isolate_grpc_proxy', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bot_swarming_grpc_proxy', full_name='swarming.SettingsCfg.bot_swarming_grpc_proxy', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='extra_child_src_csp_url', full_name='swarming.SettingsCfg.extra_child_src_csp_url', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_lifo', full_name='swarming.SettingsCfg.use_lifo', index=13,
