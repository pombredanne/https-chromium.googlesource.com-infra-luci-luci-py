...
_GETCANCELLATIONSRESPONSE_CANCELLATION_CANCELLATIONREASON = _descriptor.EnumDescriptor(
  name='CancellationReason',
  full_name='swarming.GetCancellationsResponse.Cancellation.CancellationReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_GETCANCELLATIONSRESPONSE_CANCELLATION_CANCELLATIONREASON)
...
_GETCANCELLATIONSRESPONSE_CANCELLATION = _descriptor.Descriptor(
  ...
  nested_types=[],
  enum_types=[
    _GETCANCELLATIONSRESPONSE_CANCELLATION_CANCELLATIONREASON,
  ],
  options=None,
  is_extendable=False,
  syntax='proto3',
...
_GETCANCELLATIONSRESPONSE_CANCELLATION.fields_by_name['reason'].enum_type = _GETCANCELLATIONSRESPONSE_CANCELLATION_CANCELLATIONREASON
_GETCANCELLATIONSRESPONSE_CANCELLATION.containing_type = _GETCANCELLATIONSRESPONSE
_GETCANCELLATIONSRESPONSE_CANCELLATION_CANCELLATIONREASON.containing_type = _GETCANCELLATIONSRESPONSE_CANCELLATION
