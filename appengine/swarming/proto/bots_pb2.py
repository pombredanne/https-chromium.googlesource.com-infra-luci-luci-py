...
_BOTANNOTATIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mpachine_type_ref', full_name='BotAnnotations.mpachine_type_ref', index=2,
