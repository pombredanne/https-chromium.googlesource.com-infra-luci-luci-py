...
_BOTANNOTATIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_type_ref', full_name='BotAnnotations.machine_type_ref', index=2,
...
_INCLUDEDBOTANNOTATIONS = _descriptor.Descriptor(
  name='IncludedBotAnnotations',
  full_name='IncludedBotAnnotations',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bot_annotations', full_name='IncludedBotAnnotations.bot_annotations', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INCLUDEDBOTANNOTATIONS.fields_by_name['bot_annotations'].message_type = _BOTANNOTATIONS
...
DESCRIPTOR.message_types_by_name['IncludedBotAnnotations'] = _INCLUDEDBOTANNOTATIONS
...
IncludedBotAnnotations = _reflection.GeneratedProtocolMessageType('IncludedBotAnnotations', (_message.Message,), dict(
  DESCRIPTOR = _INCLUDEDBOTANNOTATIONS,
  __module__ = 'bots_pb2'
  # @@protoc_insertion_point(class_scope:IncludedBotAnnotations)
  ))
_sym_db.RegisterMessage(IncludedBotAnnotations)
