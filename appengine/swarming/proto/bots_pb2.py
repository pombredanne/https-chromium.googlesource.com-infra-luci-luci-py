...
_MACHINETYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lease_indefinitely', full_name='MachineType.lease_indefinitely', index=7,
