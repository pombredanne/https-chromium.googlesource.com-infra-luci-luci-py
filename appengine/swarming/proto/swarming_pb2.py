...
_TASKSTATECATEGORY = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PENDING_MASK', index=1, number=16,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNNING_MASK', index=2, number=32,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRANSIENT_DONE_MASK', index=3, number=48,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EXECUTION_DONE_MASK', index=4, number=64,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='NEVER_RAN_DONE_MASK', index=5, number=80,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
_TASKSTATE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNNING_OVERHEAD_START', index=3, number=32,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNNING', index=4, number=33,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNNING_OVERHEAD_END', index=5, number=34,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DUT_FAILURE', index=7, number=48,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INTERNAL_FAILURE', index=8, number=49,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
PENDING_MASK = 16
RUNNING_MASK = 32
TRANSIENT_DONE_MASK = 48
EXECUTION_DONE_MASK = 64
NEVER_RAN_DONE_MASK = 80
INVALID = 0
PENDING = 16
PENDING_DEDUPING = 17
RUNNING_OVERHEAD_START = 32
RUNNING = 33
RUNNING_OVERHEAD_END = 34
TERMINATING = 35
DUT_FAILURE = 48
INTERNAL_FAILURE = 49
BOT_DISAPPEARED = 50
