...
_TASKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_children_tasks_outlive_parent', full_name='swarming.v1.TaskRequest.allow_children_tasks_outlive_parent', index=11,
