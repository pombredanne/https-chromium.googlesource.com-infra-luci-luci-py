...
_TASKPROPERTIES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='env_path_prefixes', full_name='swarming.v1.TaskProperties.env_path_prefixes', index=10,
...
_TASKPROPERTIES.fields_by_name['env_path_prefixes'].message_type = _STRINGLISTPAIR
