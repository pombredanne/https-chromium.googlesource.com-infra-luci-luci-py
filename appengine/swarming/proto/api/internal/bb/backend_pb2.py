...
_TASKIDLIST = _descriptor.Descriptor(
  name='TaskIDList',
  full_name='swarming.backend.TaskIDList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='task_ids', full_name='swarming.backend.TaskIDList.task_ids', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKLIST = _descriptor.Descriptor(
  name='TaskList',
  full_name='swarming.backend.TaskList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tasks', full_name='swarming.backend.TaskList.tasks', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKIDLIST.fields_by_name['task_ids'].message_type = _TASKID
...
DESCRIPTOR.message_types_by_name['TaskIDList'] = _TASKIDLIST
...
TaskIDList = _reflection.GeneratedProtocolMessageType('TaskIDList', (_message.Message,), {
  ...
  '__module__' : 'backend_pb2'
  # @@protoc_insertion_point(class_scope:swarming.backend.TaskIDList)
  })
...
TaskList = _reflection.GeneratedProtocolMessageType('TaskList', (_message.Message,), {
  ...
  '__module__' : 'backend_pb2'
  # @@protoc_insertion_point(class_scope:swarming.backend.TaskList)
  })
