...
_TASKSPEC.fields_by_name['state'].enum_type = proto_dot_api_dot_swarming__pb2._TASKSTATE
...
TaskSpec = _reflection.GeneratedProtocolMessageType('TaskSpec', (_message.Message,), dict(
  ...
  __module__ = 'proto.api.plugin_pb2'
