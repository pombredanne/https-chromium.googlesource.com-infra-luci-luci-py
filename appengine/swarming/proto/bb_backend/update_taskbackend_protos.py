...
#SUB_PATHS = {
#    'swarming/proto/api': [],
#    'buildbucket/proto': ['launcher.proto', 'common.proto', 'build.proto'],
#    'common/proto': [],
#    'resultdb/proto/v1': [],
#}
...
def main():
  ...
  google_protos = os.path.abspath(
      '../../components/third_party/protobuf/')
  paths = [
      os.path.abspath(os.path.join(base_dir, 'buildbucket/proto')),
      google_protos, base
  ]
  os.system(("../../../components/tools/compile_proto.py "
             "go.chromium.org/luci/buildbucket/proto --proto_path "
             "%s" % ','.join(paths)))
  print('Done.')
