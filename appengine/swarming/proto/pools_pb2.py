...
_POOL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_scheduler', full_name='swarming.Pool.external_scheduler', index=8,
...
_EXTERNALSCHEDULERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dimension_keys', full_name='swarming.ExternalSchedulerConfig.dimension_keys', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_POOL.fields_by_name['external_scheduler'].message_type = _EXTERNALSCHEDULERCONFIG
