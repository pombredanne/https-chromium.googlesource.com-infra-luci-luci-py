...
_TASKTEMPLATE_ENVVAR = _descriptor.Descriptor(
  name='EnvVar',
  full_name='TaskTemplate.EnvVar',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='var', full_name='TaskTemplate.EnvVar.var', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='TaskTemplate.EnvVar.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='soft', full_name='TaskTemplate.EnvVar.soft', index=2,
...
_TASKTEMPLATE_ENVPREFIX = _descriptor.Descriptor(
  name='EnvPrefix',
  full_name='TaskTemplate.EnvPrefix',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='var', full_name='TaskTemplate.EnvPrefix.var', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='path', full_name='TaskTemplate.EnvPrefix.path', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='soft', full_name='TaskTemplate.EnvPrefix.soft', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TASKTEMPLATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='env_prefix', full_name='TaskTemplate.env_prefix', index=5,
  ...
  nested_types=[_TASKTEMPLATE_CACHEENTRY, _TASKTEMPLATE_CIPDPACKAGE, _TASKTEMPLATE_ENVVAR, _TASKTEMPLATE_ENVPREFIX, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_TASKTEMPLATEDEPLOYMENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='canary_ratio', full_name='TaskTemplateDeployment.canary_ratio', index=3,
...
_TASKTEMPLATE_ENVVAR.containing_type = _TASKTEMPLATE
_TASKTEMPLATE_ENVPREFIX.containing_type = _TASKTEMPLATE
...
_TASKTEMPLATE.fields_by_name['env'].message_type = _TASKTEMPLATE_ENVVAR
_TASKTEMPLATE.fields_by_name['env_prefix'].message_type = _TASKTEMPLATE_ENVPREFIX
...
TaskTemplate = _reflection.GeneratedProtocolMessageType('TaskTemplate', (_message.Message,), dict(
  ...
  EnvVar = _reflection.GeneratedProtocolMessageType('EnvVar', (_message.Message,), dict(
    DESCRIPTOR = _TASKTEMPLATE_ENVVAR,
    __module__ = 'pools_pb2'
    # @@protoc_insertion_point(class_scope:TaskTemplate.EnvVar)
    ))
  ,

  EnvPrefix = _reflection.GeneratedProtocolMessageType('EnvPrefix', (_message.Message,), dict(
    DESCRIPTOR = _TASKTEMPLATE_ENVPREFIX,
    __module__ = 'pools_pb2'
    # @@protoc_insertion_point(class_scope:TaskTemplate.EnvPrefix)
    ))
  ,
...
_sym_db.RegisterMessage(TaskTemplate.EnvVar)
_sym_db.RegisterMessage(TaskTemplate.EnvPrefix)
