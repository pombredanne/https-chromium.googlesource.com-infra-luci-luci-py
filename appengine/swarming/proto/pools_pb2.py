...
_POOL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='external_scheduler', full_name='Pool.external_scheduler', index=8,
...
_EXTERNALSCHEDULER = _descriptor.Descriptor(
  name='ExternalScheduler',
  full_name='ExternalScheduler',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='address', full_name='ExternalScheduler.address', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='id', full_name='ExternalScheduler.id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='dimension_keys', full_name='ExternalScheduler.dimension_keys', index=2,
      number=3, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_POOL.fields_by_name['external_scheduler'].message_type = _EXTERNALSCHEDULER
...
DESCRIPTOR.message_types_by_name['ExternalScheduler'] = _EXTERNALSCHEDULER
...
ExternalScheduler = _reflection.GeneratedProtocolMessageType('ExternalScheduler', (_message.Message,), dict(
  DESCRIPTOR = _EXTERNALSCHEDULER,
  __module__ = 'pools_pb2'
  # @@protoc_insertion_point(class_scope:ExternalScheduler)
  ))
_sym_db.RegisterMessage(ExternalScheduler)
