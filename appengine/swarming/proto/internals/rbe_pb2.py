...
_SERVERSECRET_KEY = _descriptor.Descriptor(
  name='Key',
  full_name='swarming.internals.rbe.ServerSecret.Key',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='swarming.internals.rbe.ServerSecret.Key.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='key', full_name='swarming.internals.rbe.ServerSecret.Key.key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='created', full_name='swarming.internals.rbe.ServerSecret.Key.created', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expiry', full_name='swarming.internals.rbe.ServerSecret.Key.expiry', index=3,
...
_SERVERSECRET = _descriptor.Descriptor(
  name='ServerSecret',
  full_name='swarming.internals.rbe.ServerSecret',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='swarming.internals.rbe.ServerSecret.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='keys', full_name='swarming.internals.rbe.ServerSecret.keys', index=1,
  ...
  nested_types=[_SERVERSECRET_KEY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TAGGEDMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='key_id', full_name='swarming.internals.rbe.TaggedMessage.key_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='hmac_sha256', full_name='swarming.internals.rbe.TaggedMessage.hmac_sha256', index=3,
...
_SERVERSECRET_KEY.fields_by_name['created'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_SERVERSECRET_KEY.fields_by_name['expiry'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_SERVERSECRET_KEY.containing_type = _SERVERSECRET
_SERVERSECRET.fields_by_name['keys'].message_type = _SERVERSECRET_KEY
...
DESCRIPTOR.message_types_by_name['ServerSecret'] = _SERVERSECRET
...
ServerSecret = _reflection.GeneratedProtocolMessageType('ServerSecret', (_message.Message,), {

  'Key' : _reflection.GeneratedProtocolMessageType('Key', (_message.Message,), {
    'DESCRIPTOR' : _SERVERSECRET_KEY,
    '__module__' : 'proto.internals.rbe_pb2'
    # @@protoc_insertion_point(class_scope:swarming.internals.rbe.ServerSecret.Key)
    })
  ,
  'DESCRIPTOR' : _SERVERSECRET,
  '__module__' : 'proto.internals.rbe_pb2'
  # @@protoc_insertion_point(class_scope:swarming.internals.rbe.ServerSecret)
  })
_sym_db.RegisterMessage(ServerSecret)
_sym_db.RegisterMessage(ServerSecret.Key)
