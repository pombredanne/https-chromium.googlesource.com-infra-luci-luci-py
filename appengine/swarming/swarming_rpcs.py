...
class TaskSlice(messages.Message):
  ...
  deny_if_no_worker = messages.BooleanField(3, default=False)
...
class NewTaskRequest(messages.Message):
  ...
  # Slice of TaskProperties, along their scheduling parameters. Cannot be used
  # at the same time as properties and expiration_secs.
...
class TaskResult(messages.Message):
  ...
  # Index in the TaskRequest.task_slices of the TaskProperties that this result
  # represents.
