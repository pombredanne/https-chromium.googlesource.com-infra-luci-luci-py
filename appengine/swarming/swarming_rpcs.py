...
class TaskProperties(messages.Message):
  ...
  #
  # The same envvar can be specified multiple times in this field to prepend
  # multiple paths. They will be prepended in the order seen here.
  #
  ...
  env_prefixes = messages.MessageField(StringPair, 14, repeated=True)
