...
class NewTaskRequest(messages.Message):
  ...
  # is guaranteed that at most once of these will be processed.
...
class TaskResult(messages.Message):
  ...
  # Index in the TaskRequest.task_slices (TaskSlice instance) of the
  # TaskProperties that this result represents.
