...
def _task_properties_from_rpc(props):
  # type: (swarming_pb2.TaskProperties) -> task_request.TaskProperties
  cipd_input = None
...
def _task_slice_from_rpc(task_slice):
  # type: (swarming_pb2.TaskSlice) -> task_request.TaskSlice
...
def new_task_request_from_rpc(request):
  ...
  """
  # type: (swarming_pb2.NewTaskRequest) -> task_request.TaskRequest
