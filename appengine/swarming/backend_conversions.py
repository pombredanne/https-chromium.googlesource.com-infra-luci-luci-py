...
def compute_task_request(run_task_req):
  ...
  tr = task_request.TaskRequest(
      ...
      bot_ping_tolerance_secs=backend_config.bot_ping_tolerance_secs,
...
def _ingest_backend_config(req_backend_config):
  ...
  return swarming_bb_pb2.SwarmingBackendConfig(
      priority = int(req_backend_config.fields['priority'].number_value),
      bot_ping_tolerance_secs = int(
          req_backend_config.fields['bot_ping_tolerance'].number_value),
      parent_run_id = req_backend_config.fields['parent_run_id'].string_value,
      service_account = req_backend_config.fields[
          'service_account'].string_value,
      wait_for_capacity = req_backend_config.fields[
          'wait_for_capacity'].bool_value,
      agent_binary_cipd_pkg = req_backend_config.fields[
          'agent_binary_cipd_pkg'].string_value,
      agent_binary_cipd_vers = req_backend_config.fields[
          'agent_binary_cipd_vers'].string_value,
      agent_binary_cipd_filename = req_backend_config.fields[
          'agent_binary_cipd_filename'].string_value)
