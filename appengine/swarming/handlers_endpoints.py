...
class SwarmingTasksService(remote.Service):
  ...
  def cancel(self, request):
    ...
    # to an thousand entities loaded in memory, and this is a pure memory leak,
    # as there's no chance this specific instance will need these again -> this
    # leads to 'Exceeded soft memory limit' AppEngine errors.
