...
def _get_task_request(request_key, viewing):
  ...
  if viewing == _VIEW:
    ...
    raise endpoints.InternalServerErrorException('_get_task_request()')
  return request


def _get_request_and_result(task_id, viewing, use_memcache):
  ...
  try:
    request = _get_task_request(request_key, viewing)
  finally:
...
class SwarmingTaskService(remote.Service):
  ...
  def request(self, request):
    ...
    request_obj = _get_task_request(request_key, _VIEW)
  ...
  def cancel(self, request):
    ...
    request_obj = _get_task_request(request_key, v_EDIT)
