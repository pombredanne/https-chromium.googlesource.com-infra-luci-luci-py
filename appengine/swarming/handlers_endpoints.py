...
def apply_server_property_defaults(properties):
  ...
  Essentially:
   - If a property is set by the task explicity, use that. Else:
  ...
  if pool_cfg and pool_cfg.default_cipd:
    ...
    cipd_client = pool_cfg.default_cipd.client_package.package_name
    cipd_vers = pool_cfg.default_cipd.client_package.version
