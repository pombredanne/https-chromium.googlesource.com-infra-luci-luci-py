...
class CronExternalSchedulerGenBatchRequestsHandler(webapp2.RequestHandler):
...
def get_routes():
  ...
  routes = [
    ...
    ('/internal/cron/important/external_scheduler/gen_batch_requests',
        CronExternalSchedulerGenBatchRequestsHandler),
