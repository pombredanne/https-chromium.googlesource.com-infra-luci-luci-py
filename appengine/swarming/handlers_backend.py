...
class TaskESNotifyKickersHandler(webapp2.RequestHandler):
  """Kicks off the pull queue worker to batch the es-nofitifications."""

  @decorators.require_taskqueue('es-notify-kickers')
  def post(self):
    external_scheduler.task_gen_batch_requests()
