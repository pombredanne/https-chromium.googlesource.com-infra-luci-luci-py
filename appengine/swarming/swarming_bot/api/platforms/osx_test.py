...
class TestOsx(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.mock_subprocess = mock.patch('subprocess.check_output').start()
  ...
  def test_get_hardware_model_string(self):
    self.mock_subprocess.return_value = b'MacBookPro15,1\n'
  ...
  def test_get_audio(self):
    ...
    self.mock_subprocess.return_value = plist
