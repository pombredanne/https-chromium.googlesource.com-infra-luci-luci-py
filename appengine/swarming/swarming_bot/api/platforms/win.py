...
def is_display_attached():
  ...
  """
  # This Powershell command outputs a number of fields and their values in the
  # format "Field : Value", one entry per line. When a display is attached and
  ...
  output = subprocess.check_output(
      ['powershell.exe', 'Get-WMIObject win32_controller'])
