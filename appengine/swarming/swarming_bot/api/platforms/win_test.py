...
class TestWinPlatformIndendent(auto_stub.TestCase):
  ...
  def test_is_display_attached_valid_display(self):
    SWbemObject = mock.Mock(
        CurrentHorizontalResolution=1280, CurrentVerticalResolution=720)
    SWbemServices = mock.Mock()
  ...
  def test_is_display_attached_missing_display(self):
    # Both fields missing.
    SWbemObject = mock.Mock(
        CurrentHorizontalResolution=None, CurrentVerticalResolution=None)
    SWbemServices = mock.Mock()
    SWbemServices.query.return_value = [SWbemObject]
    with mock.patch(
        'api.platforms.win._get_wmi_wbem', return_value=SWbemServices):
    ...
    # First field missing.
    SWbemObject = mock.Mock(
        CurrentHorizontalResolution=None, CurrentVerticalResolution=720)
    SWbemServices = mock.Mock()
    SWbemServices.query.return_value = [SWbemObject]
    with mock.patch(
        'api.platforms.win._get_wmi_wbem', return_value=SWbemServices):
    ...
    SWbemObject = mock.Mock(
        CurrentHorizontalResolution=1280, CurrentVerticalResolution=None)
    SWbemServices = mock.Mock()
    SWbemServices.query.return_value = [SWbemObject]
    with mock.patch(
        'api.platforms.win._get_wmi_wbem', return_value=SWbemServices):
