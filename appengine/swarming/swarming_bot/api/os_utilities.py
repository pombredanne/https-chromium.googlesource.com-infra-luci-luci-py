...
def _set_display_resolution_state(state, resolution):
  if resolution:
    state['display_horizontal_resolution'] = resolution[0]
    state['display_vertical_resolution'] = resolution[1]
  else:
    state['display_horizontal_resolution'] = 'unavailable'
    state['display_vertical_resolution'] = 'unavailable'
