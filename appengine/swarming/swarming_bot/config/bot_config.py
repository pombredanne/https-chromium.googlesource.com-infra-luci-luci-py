...
def on_before_task(bot, bot_file, runner_cmd, runner_env):
  ...
  - runner_cmd: Command to be executed to launch task runner. This can be used
                to override the task runner, modify its arguments and/or add a
                wrapper script around it.
  - runner_env: Environment in which test runner is launched.
  """
  pass
