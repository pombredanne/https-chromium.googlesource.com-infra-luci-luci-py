...
def main():
  ...
  try:
    logging_utils.add_rotating_file_handler(logger, perm_log_location)
  except OSError:
    logging.exception("Failed to create logging directory at path: %s for %s\n",
                      base_dir, 'swarming_bot_init.log')
