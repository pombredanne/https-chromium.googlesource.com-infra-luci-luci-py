...
class RemoteClientNative(object):
  ...
  def claim(self, attributes, claim_id, task_id, task_to_run_shard,
    ...
    This is used by bots in RBE mode to claim tasks they received via RBE.

    Arguments:
      claim_id: an opaque string claim ID used to make the request idempotent.
    ...
    Returns one of:
      ...
      ('terminate', '<task-id>') if picked up the termination task.
