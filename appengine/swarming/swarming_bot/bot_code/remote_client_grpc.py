...
class RemoteClientGrpc(object):
  ...
  def post_bot_event(self, event_type, message, _attributes):
    ...
    req_type, status = {
        ...
        'bot_rebooting': (bots_pb2.PostBotEventTempRequest.INFO, bots_pb2.HOST_REBOOTING),
        'bot_shutdown': (bots_pb2.PostBotEventTempRequest.INFO, bots_pb2.BOT_TERMINATING),
