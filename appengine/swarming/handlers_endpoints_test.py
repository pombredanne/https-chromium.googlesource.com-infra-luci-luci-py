...
class TasksApiTest(BaseTest):
  ...
  def test_new_ok_raw(self):
    ...
    # do auth check.
    self.assertEqual([(u'service-account@example.com',
                       datetime.timedelta(0, 30 + 30 + 15))] * 2,
                     oauth_grant_calls)
            ...
            for sort in TaskSort:
              ...
              if ((using_filter, state, sort) in blacklisted or
                ...
                try:
                  ...
                  self.fail('Is unsupported: (%s, %s, %s)' % (using_filter,
                                                              state, sort))
  ...
  def test_tags_ok(self):
    ...
    expected = {
        ...
        u'ts':
            fmtdate(self.now, DATETIME_NO_MICRO),
    }
...
class BotsApiTest(BaseTest):
  ...
  def test_list_ok(self):
    ...
    bot3 = {
        ...
        u'external_ip':
            u'8.8.4.4',
        u'first_seen_ts':
            fmtdate(then, DATETIME_NO_MICRO),
        u'is_dead':
            False,
        u'last_seen_ts':
            fmtdate(then, DATETIME_NO_MICRO),
  ...
  def test_dimensions_ok(self):
    ...
    expected = {
        ...
        u'ts':
            unicode(self.now.strftime(DATETIME_NO_MICRO)),
    }
