 ...
 */const n=new class{handleAttributeExpressions(t,e,s,n){const r=e[0];if("."===r){return new i.f(t,e.slice(1),s).parts}return"@"===r?[new i.d(t,e.slice(1),n.eventContext)]:"?"===r?[new i.c(t,e.slice(1),s)]:new i.a(t,e,s).parts}handleTextExpression(t){return new i.e(t)}};var r=s(12),a=s(11),o=s(8),d=(s(5),s(2));
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const i=new WeakMap,n=t=>(...e)=>{const s=t(...e);return i.set(s,!0),s},r=t=>"function"==typeof t&&i.has(t)},function(t,e,s){"use strict";s.d(e,"b",(function(){return r})),s.d(e,"a",(function(){return a}));var i=s(8),n=s(2);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class r{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="";for(let s=0;s<t;s++){const t=this.strings[s],i=n.e.exec(t);e+=i?t.substr(0,i.index)+i[1]+i[2]+n.b+i[3]+n.f:t+n.g}return e+this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class a extends r{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,s=e.firstChild;return e.removeChild(s),Object(i.c)(e,s.firstChild),t}}},function(t,e,s){"use strict";s.d(e,"a",(function(){return n})),s.d(e,"e",(function(){return d})),s.d(e,"c",(function(){return c})),s.d(e,"b",(function(){return l})),s.d(e,"d",(function(){return u}));const i=[{units:"w",delta:604800},{units:"d",delta:86400},{units:"h",delta:3600},{units:"m",delta:60},{units:"s",delta:1}],n=1048576,r=1024*n,a=1024*r,o=[{units:" PB",delta:1024*a},{units:" TB",delta:a},{units:" GB",delta:r},{units:" MB",delta:n},{units:" KB",delta:1024},{units:" B",delta:1}];function d(t){if(t<0&&(t=-t),0===t)return"  0s";let e="";for(let s=0;s<i.length;s++)if(i[s].delta<=t){let n=Math.floor(t/i[s].delta)+i[s].units;for(;n.length<4;)n=" "+n;e+=n,t%=i[s].delta}return e}function c(t){let e=(("number"==typeof t?t:Date.parse(t))-Date.now())/1e3;return e<0&&(e*=-1),h(e,i)}function l(t,e=1){return Number.isInteger(e)&&(t*=e),h(t,o)}function u(t){let e=t.toString(),s=e.substring(e.indexOf("("));return t.toLocaleString()+" "+s}function h(t,e){for(let s=0;s<e.length-1;s++){if(Math.round(t/e[s+1].delta)*e[s+1].delta/e[s].delta>=1)return Math.round(t/e[s].delta)+e[s].units}let s=e.length-1;return Math.round(t/e[s].delta)+e[s].units}},function(t,e,s){},function(t,e,s){"use strict";s.d(e,"a",(function(){return a})),s.d(e,"b",(function(){return o})),s.d(e,"c",(function(){return d})),s.d(e,"d",(function(){return c})),s.d(e,"e",(function(){return l})),s.d(e,"f",(function(){return u})),s.d(e,"h",(function(){return h})),s.d(e,"g",(function(){return p})),s.d(e,"i",(function(){return _})),s.d(e,"j",(function(){return f})),s.d(e,"k",(function(){return m})),s.d(e,"l",(function(){return g})),s.d(e,"m",(function(){return b})),s.d(e,"n",(function(){return v})),s.d(e,"p",(function(){return k})),s.d(e,"o",(function(){return w})),s.d(e,"q",(function(){return y})),s.d(e,"r",(function(){return $}));var i=s(13),n=s(4),r=s(20);function a(t){return t&&t.properties&&t.properties.idempotent}function o(t,e){if(!t||!e)return;const s=t.split(":");return 2===s.length?`${e}/p/${s[0]}/+/${s[1]}`:void 0}function d(t){let e=0,s=0;return t.performance_stats&&(s=t.performance_stats.isolated_upload&&t.performance_stats.isolated_upload.duration||0,e=t.performance_stats.bot_overhead-s),[t.pending,e,t.duration,s].map((function(t){return t?Math.round(10*t)/10:0}))}function c(t,e){const s=t.filter((function(t){return t.key===e}));if(!s.length)return null;const i=s[0].value;return i.length?i[0]:null}function l(t){if(!t||!t._request||!t._request.tagMap)return!1;const e=t._request.tagMap;return e.allow_milo||e.luci_project}function u(t,e){if(!t||!t.state)return"";if(void 0!==e&&t.current_task_slice!==e)return"THIS SLICE DID NOT RUN. Select another slice above.";const s=t.state;return"COMPLETED"===s?t.failure?"COMPLETED (FAILURE)":y(t)?"COMPLETED (DEDUPED)":"COMPLETED (SUCCESS)":s}function h(t){return t.isolatedserver+"/browse?namespace="+t.namespace+"&hash="+t.isolated}function p(t){return t&&t.endsWith(0)}function _(t){if(!t)return{};t.tagMap={},t.tags=t.tags||[];for(const e of t.tags){const s=e.split(":",1)[0],i=e.substring(s.length+1);t.tagMap[s]=i}return E.forEach(e=>{Object(n.h)(t,e)}),t}function f(t){if(!t)return{};E.forEach(e=>{Object(n.h)(t,e)}),t.try_number&&(t.try_number=+t.try_number);const e=new Date;!t.duration&&"RUNNING"===t.state&&t.started_ts?t.duration=(e-t.started_ts)/1e3:!t.duration&&"BOT_DIED"===t.state&&t.started_ts&&t.abandoned_ts&&(t.duration=(t.abandoned_ts-t.started_ts)/1e3),t.human_duration=Object(n.d)(t.duration),"RUNNING"===t.state?t.human_duration+="*":"BOT_DIED"===t.state&&(t.human_duration+=" -- died");const s=t.started_ts||t.abandoned_ts||new Date;return t.created_ts?s<=t.created_ts?(t.pending=0,t.human_pending="0s"):(t.pending=(s-t.created_ts)/1e3,t.human_pending=Object(n.l)(t.created_ts,s)):(t.pending=0,t.human_pending=""),t.current_task_slice=parseInt(t.current_task_slice)||0,t}function m(t){if(!t||!t._request||!t._request.tagMap)return;const e=t._request.tagMap,s=e.milo_host;let i=e.log_location;if(i&&s){if(i=i.replace("logdog://",""),-1!==i.indexOf("${SWARMING_TASK_ID}")){if(!t._result||!t._result.run_id)return;i=i.replace("${SWARMING_TASK_ID}",t._result.run_id)}return s.replace("%s",i)}const n=t.server_details.display_server_url_template;return n&&t._taskId?n.replace("%s",t._taskId):void 0}function g(t,e){if(!e.created_ts)return"";const s=1e3*t.expiration_secs;return i.d(new Date(e.created_ts.getTime()+s))}function b(t){if(!t||!t.state)return"";const e=t.state;return r.b.has(e)?"exception":"BOT_DIED"===e?"bot_died":r.d.has(e)?"pending_task":"COMPLETED"===e&&t.failure?"failed_task":""}function v(t){return t&&t.costs_usd&&t.costs_usd.length?t.costs_usd[0].toFixed(4):0}function k(t){if(!t.created_ts)return"";const e=1e3*t.expiration_secs;return i.d(new Date(t.created_ts.getTime()+e))}function w(t,e){return t&&e&&-1!==t._currentSliceIdx&&t._currentSliceIdx!==e.current_task_slice?"inactive":""}function y(t){return 0===t.try_number}function $(t){return t&&"PENDING"!==t.state&&"NO_RESOURCE"!==t.state&&"CANCELED"!==t.state&&"EXPIRED"!==t.state}const E=["abandoned_ts","completed_ts","created_ts","modified_ts","started_ts"]},function(t,e,s){"use strict";s.d(e,"a",(function(){return r}));var i=s(8),n=s(2);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const a=new WeakMap,o=Object(r.b)((t,e)=>s=>{const i=a.get(s);if(Array.isArray(t)){if(Array.isArray(i)&&i.length===t.length&&t.every((t,e)=>t===i[e]))return}else if(i===t&&(void 0!==t||a.has(s)))return;s.setValue(e()),a.set(s,Array.isArray(t)?Array.from(t):t)});var d=s(17),c=s(9),l=s(23);s(30),s(39),s(40),s(24),s(34);const u=Symbol("loadScript"),h=Symbol("instance");let p;class _{get[h](){return p}set[h](t){p=t}constructor(){if(this[h])return this[h];this[h]=this}reset(){p=null}[u](){return this.scriptPromise||(this.scriptPromise=new Promise(t=>{const e=document.getElementsByTagName("body")[0],s=document.createElement("script");s.type="text/javascript",s.onload=function(){f.api=window.google,f.api.charts.load("current",{packages:["corechart","table"]}),f.api.charts.setOnLoadCallback(()=>{t()})},s.src="https://www.gstatic.com/charts/loader.js",e.appendChild(s)})),this.scriptPromise}load(t,e){return this[u]().then(()=>{if(e){let s={};s=e instanceof Object?e:Array.isArray(e)?{packages:e}:{packages:[e]},this.api.charts.load("current",s),this.api.charts.setOnLoadCallback(t)}else{if("function"!=typeof t)throw"callback must be a function";t()}})}}const f=new _;var m=s(4);const g=new Promise((t,e)=>{try{f.load(t)}catch(t){e(t)}});function b(t){return"string"==typeof t?JSON.parse(t):t}window.customElements.define("stacked-time-chart",class extends HTMLElement{constructor(){super(),this._loaded=!1,this._error=""}connectedCallback(){Object(m.e)(this,"colors"),Object(m.e)(this,"labels"),Object(m.e)(this,"values"),this._colors=b(this._colors),this._labels=b(this._labels),this._values=b(this._values),g.then(()=>{this._loaded=!0,this.render()}).catch(t=>{console.error(t),this._error="Could not load Google Charts JS from Internet",this.render()}),this.render()}get colors(){return this._colors}set colors(t){this._colors=t,this.render()}get labels(){return this._labels}set labels(t){this._labels=t,this.render()}get values(){return this._values}set values(t){this._values=t,this.render()}drawChart(){const t=f.api.visualization.arrayToDataTable([["Type"].concat(this._labels),[""].concat(this._values)]);let e=0;for(const t of this._values)e+=+t;const s=[{v:0,f:""}];let i=0;if(e<120){for(let t=10;t<e;t+=10)s.push({v:t,f:t+"s"});i=5}else if(e<1500){for(let t=60;t<e;t+=60)s.push({v:t,f:t/60+"m"});i=e<300?5:e<900?1:0}else if(e<1e6){for(let t=600;t<e;t+=600)s.push({v:t,f:t/60+"m"});i=e<6e3?10:e<12e3?5:1}const n={width:400,height:250,isStacked:!0,chartArea:{width:"100%",height:"65%"},legend:{position:"top",maxLines:1,alignment:"center",textStyle:{fontSize:12}},colors:this._colors,hAxis:{title:"Time",ticks:s,minorGridlines:{count:i}}};new f.api.visualization.BarChart(this.firstElementChild).draw(t,n)}render(){var t;Object(r.d)((t=this,r.c`<div id=chart>${t._error}</div>`),this,{eventContext:this}),this._loaded&&this.drawChart()}});s(29);var v=s(13),k=s(10),w=s(18),y=s(15),$=s(21);const E='resource.type="gae_app"\n'+['protoPayload.resource>="/internal/"','protoPayload.resource>="/swarming/api/v1/bot/"','protoPayload.method!="GET"'].join(" OR ")+"\n",I=(t,e,s)=>{let i="https://console.cloud.google.com/logs/viewer";if(i+=`?project=${t._project_id}`,i+="&resource=gae_app",e.created_ts){const t=new Date(e.created_ts.getTime()-6e4),n=s.completed_ts||s.abandoned_ts,r=n?new Date(n.getTime()+6e4):new Date;i+="&interval=CUSTOM",i+=`&dateRangeStart=${t.toISOString()}`,i+=`&dateRangeEnd=${r.toISOString()}`}return i},O=(t,e)=>{if(!t.task_id)return r.c`<tr><td>&lt;loading&gt;</td><td></td><td></td></tr>`;let s=t.task_id.substring(0,t.task_id.length-1);return s+=e+1,r.c`
<tr>
  <td>
    <a href=${Object(d.a)(Object(m.j)(s,!0))} target=_blank>
      ${s}
    </a>
  </td>
  <td>
    <a href=${Object(d.a)(Object(m.b)(t.bot_id))} target=_blank>
      ${t.bot_id}
    </a>
  </td>
  <td class=${Object(y.m)(t)}>${Object(y.f)(t)}</td>
</tr>
`},T=(t,e)=>r.c`
...
<tr>
  <td>State</td>
  <td class=${Object(y.m)(s)}>${Object(y.f)(s,t._currentSliceIdx)}</td>
</tr>
${C(s,t._capacityCounts[t._currentSliceIdx],t._pendingCounts[t._currentSliceIdx],t._runningCounts[t._currentSliceIdx],t._currentSlice.properties||{})}
<tr ?hidden=${!s.deduped_from} class=highlighted>
  <td><b>Deduped From</b></td>
  <td>
    <a href=${Object(m.j)(s.deduped_from)} target=_blank>
      ${s.deduped_from}
    </a>
  </td>
</tr>
...
<tr>
  ...
  <td>
    ${D(e,"count")}
    <a href=${Object(m.a)(n.dimensions)}>bots</a>
    could possibly run this task
    (${D(e,"busy")} busy,
    ${D(e,"dead")} dead,
    ${D(e,"quarantined")} quarantined,
...
<tr>
  ...
  <td>
      ${D(s)}
      <a href=${Object(m.i)(n.dimensions,[],"state:PENDING")}>
        similar pending tasks</a>,
      ${D(i)}
      <a href=${Object(m.i)(n.dimensions,[],"state:RUNNING")}>
        similar running tasks</a>
  </td>
</tr>
`,D=(t,e)=>!t||e&&void 0===t[e]?r.c`<span class=italic>&lt;counting&gt</span>`:e?t[e]:t,S=(t,e,s)=>r.c`
<tr>
  <td>Priority</td>
  <td>${t.priority}</td>
</tr>
...
<tr ?hidden=${!t.parent_task_id}>
  <td>Parent Task</td>
  <td>
    <a href=${Object(m.j)(t.parent_task_id)}>
      ${t.parent_task_id}
    </a>
  </td>
</tr>
...
<tr>
  <td rowspan=${t.length+1}>
    ...
    <a  title="The list of bots that matches the list of dimensions"
        href=${Object(m.a)(t)}>Bots</a>
    <a  title="The list of tasks that matches the list of dimensions"
        href=${Object(m.i)(t)}>Tasks</a>
  </td>
</tr>
${t.map(N)}
`,N=t=>r.c`
<tr>
  <td class=break-all><b class=dim_key>${t.key}:</b>${Object(w.a)(t.value,t.key)}</td>
</tr>
...
${P(e,"Environment Vars",t=>t.key+"="+t.value)}
${P(s,"Environment Prefixes",t=>t.key+"="+t.value.join(":"))}
<tr>
  <td>Idempotent</td>
  <td>${!!t.idempotent}</td>
</tr>
`,G=(t,e)=>{if(!t)return r.c`
<tr>
  <td>Uses CIPD</td>
  <td>false</td>
...
`,B=(t,e,s)=>{if(!t._taskId||t._notFound)return"";let i=null,n=null;if(s&&s.bot_dimensions)for(const t of s.bot_dimensions)"gcp"==t.key&&(i=t.value[0]),"os"==t.key&&(n=t.value[0]);const a=i&&"Linux"==n;return r.c`
  ...
  <table class="task-info left">
    <tbody>
      <tr>
        ...
        <td>
          <a href=${((t,e,s)=>{let i=I(t,e,s),n=E;return n+=`${t._taskId.slice(0,-1)}`,i+=`&advancedFilter=${n}`,encodeURI(i)})(t,e,s)} target="_blank">
      ...
      <tr>
        ...
        <td>
          <a href=${((t,e,s)=>{let i=I(t,e,s),n=E;return n+=`${s.bot_id}`,i+=`&advancedFilter=${n}`,encodeURI(i)})(t,e,s)} target="_blank"
             ?hidden=${!s.bot_id}>
            View on Cloud Console
          </a>
          <p ?hidden=${s.bot_id}>--</p>
...
<tr>
  <td class=${t.highlight?"highlight":""}>
    <b class=dim_key>${t.key}:</b>${t.values.map(V)}
  </td>
</tr>
`,V=t=>r.c`<span class="break-all dim ${t.bold?"bold":""}">${t.name}</span>`,F=t=>r.c`<div>${t}</div>`,q=t=>o([t._request,t._showRawOutput,t._stdout.length,t._stdoutOffset,t._wideLogs],()=>t._showRawOutput||!Object(y.e)(t)?r.c`
<div class="code stdout tabbed ${t._wideLogs?"wide":"break-all"}"
  >${t._stdout.map(F)}
</div>`:Object(y.g)(t._taskId)?r.c`
<iframe id=richLogsFrame class=tabbed src=${Object(d.a)(Object(y.k)(t))}></iframe>`:r.c`
<div class=tabbed>
...
<div class=slice-picker>
  ${t._request.task_slices.map((e,s)=>T(t,s))}
</div>`:"")(t)}

    ${((t,e,s,i)=>!t._taskId||t._notFound?"":(i.properties||(i.properties={}),r.c`
<table class="task-info request-info ${Object(y.o)(t,s)}">
<tbody>
  <tr>
    <td>Name</td>
    <td>${e.name}</td>
  ...
  ${x(t,e,s)}
  ${S(e,s,i)}
  ${j(i.properties.dimensions||[])}
  ${A("Isolated Inputs",i.properties.inputs_ref||{})}
  ${P(i.properties.outputs,"Expected outputs",t=>t)}
  ${M(e.tagMap)}
...
<tbody ?hidden=${!t._showDetails}>
  ${R(i.properties,i.properties.env||[],i.properties.env_prefixes||[])}

  ${P(e.tags,"Tags",t=>t)}
  <tr>
    <td>Execution timeout</td>
    <td>${Object(m.d)(i.properties.execution_timeout_secs)}</td>
  </tr>
  <tr>
    <td>I/O timeout</td>
    <td>${Object(m.d)(i.properties.io_timeout_secs)}</td>
  </tr>
  <tr>
    <td>Grace period</td>
    <td>${Object(m.d)(i.properties.grace_period_secs)}</td>
  </tr>

  ${G(i.properties.cipd_input,s)}
  ${P(i.properties.caches,"Named Caches",t=>t.name+":"+t.path)}
</tbody>
</table>
`))(t,t._request,t._result,t._currentSlice)}

    ${((t,e,s)=>{if(!t._taskId||t._notFound||Object(y.q)(s))return"";const i=s.performance_stats||{};return r.c`
  ...
  <table class="task-info task-timing left">
    <tbody>
      ...
      <tr>
        ...
        <td class=overhead>${Object(m.d)(i.bot_overhead)}</td>
      </tr>
      <tr>
        <td>Running Time</td>
...
<p class=deduplicated>
  ...
  the docs</a>.
</p>`;i.properties||(i.properties={});const n=s.bot_dimensions||[],a=i.properties.dimensions||[];for(const t of n){for(const e of a)e.key===t.key&&(t.highlight=!0);if(t.values=[],t.value)for(const e of t.value){const s={name:Object(w.a)(e,t.key)};for(const i of a)i.key===t.key&&i.value===e&&(s.bold=!0);t.values.push(s)}}return r.c`
<div class=title>Task Execution</div>
<table class=task-execution>
  <tr>
    <td>Bot assigned to task</td>
    <td><a href=${Object(m.b)(s.bot_id)}>${s.bot_id}</td>
  </tr>
  <tr>
...
<div class="horizontal layout">
  <div class=output-picker>
    <div class=tab ?selected=${!t._showRawOutput&&Object(y.e)(t)}
                   ?disabled=${!Object(y.e)(t)}
                   @click=${t._toggleOutput}>
      <a rel=noopener target=_blank href=${Object(d.a)(Object(y.k)(t))}>
        Rich Output
      </a>
    </div>
    <div class=tab ?selected=${t._showRawOutput||!Object(y.e)(t)}
    ...
    <checkbox-sk id=wide_logs ?checked=${t._wideLogs} @click=${t._toggleWidth}></checkbox-sk>
