 ...
 */const i=new class{handleAttributeExpressions(t,e,s,i){const r=e[0];if("."===r){return new n.f(t,e.slice(1),s).parts}return"@"===r?[new n.d(t,e.slice(1),i.eventContext)]:"?"===r?[new n.c(t,e.slice(1),s)]:new n.a(t,e,s).parts}handleTextExpression(t){return new n.e(t)}};var r=s(12),o=s(11),a=s(9),d=(s(5),s(2));
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const n=new WeakMap,i=t=>(...e)=>{const s=t(...e);return n.set(s,!0),s},r=t=>"function"==typeof t&&n.has(t)},function(t,e,s){"use strict";s.d(e,"b",(function(){return r})),s.d(e,"a",(function(){return o}));var n=s(9),i=s(2);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class r{constructor(t,e,s,n){this.strings=t,this.values=e,this.type=s,this.processor=n}getHTML(){const t=this.strings.length-1;let e="";for(let s=0;s<t;s++){const t=this.strings[s],n=i.e.exec(t);e+=n?t.substr(0,n.index)+n[1]+n[2]+i.b+n[3]+i.f:t+i.g}return e+this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}class o extends r{getHTML(){return`<svg>${super.getHTML()}</svg>`}getTemplateElement(){const t=super.getTemplateElement(),e=t.content,s=e.firstChild;return e.removeChild(s),Object(n.c)(e,s.firstChild),t}}},function(t,e,s){"use strict";s.d(e,"a",(function(){return i})),s.d(e,"e",(function(){return d})),s.d(e,"c",(function(){return l})),s.d(e,"b",(function(){return c})),s.d(e,"d",(function(){return h}));const n=[{units:"w",delta:604800},{units:"d",delta:86400},{units:"h",delta:3600},{units:"m",delta:60},{units:"s",delta:1}],i=1048576,r=1024*i,o=1024*r,a=[{units:" PB",delta:1024*o},{units:" TB",delta:o},{units:" GB",delta:r},{units:" MB",delta:i},{units:" KB",delta:1024},{units:" B",delta:1}];function d(t){if(t<0&&(t=-t),0===t)return"  0s";let e="";for(let s=0;s<n.length;s++)if(n[s].delta<=t){let i=Math.floor(t/n[s].delta)+n[s].units;for(;i.length<4;)i=" "+i;e+=i,t%=n[s].delta}return e}function l(t){let e=(("number"==typeof t?t:Date.parse(t))-Date.now())/1e3;return e<0&&(e*=-1),u(e,n)}function c(t,e=1){return Number.isInteger(e)&&(t*=e),u(t,a)}function h(t){let e=t.toString(),s=e.substring(e.indexOf("("));return t.toLocaleString()+" "+s}function u(t,e){for(let s=0;s<e.length-1;s++){if(Math.round(t/e[s+1].delta)*e[s+1].delta/e[s].delta>=1)return Math.round(t/e[s].delta)+e[s].units}let s=e.length-1;return Math.round(t/e[s].delta)+e[s].units}},function(t,e,s){},function(t,e,s){"use strict";s.d(e,"a",(function(){return o})),s.d(e,"b",(function(){return a})),s.d(e,"c",(function(){return d})),s.d(e,"d",(function(){return l})),s.d(e,"e",(function(){return c})),s.d(e,"f",(function(){return h})),s.d(e,"g",(function(){return u})),s.d(e,"h",(function(){return _})),s.d(e,"i",(function(){return p})),s.d(e,"j",(function(){return f})),s.d(e,"k",(function(){return m})),s.d(e,"l",(function(){return b})),s.d(e,"m",(function(){return g})),s.d(e,"o",(function(){return v})),s.d(e,"n",(function(){return k})),s.d(e,"p",(function(){return w})),s.d(e,"q",(function(){return E}));var n=s(13),i=s(4),r=s(20);function o(t){return t&&t.properties&&t.properties.idempotent}function a(t,e){if(!t||!e)return;const s=t.split(":");return 2===s.length?`${e}/p/${s[0]}/+/${s[1]}`:void 0}function d(t){let e=0,s=0;return t.performance_stats&&(s=t.performance_stats.isolated_upload&&t.performance_stats.isolated_upload.duration||0,e=t.performance_stats.bot_overhead-s),[t.pending,e,t.duration,s].map((function(t){return t?Math.round(10*t)/10:0}))}function l(t,e){const s=t.filter((function(t){return t.key===e}));if(!s.length)return null;const n=s[0].value;return n.length?n[0]:null}function c(t){if(!t||!t._request||!t._request.tagMap)return!1;const e=t._request.tagMap;return e.allow_milo||e.luci_project}function h(t,e){if(!t||!t.state)return"";if(void 0!==e&&t.current_task_slice!==e)return"THIS SLICE DID NOT RUN. Select another slice above.";const s=t.state;return"COMPLETED"===s?t.failure?"COMPLETED (FAILURE)":w(t)?"COMPLETED (DEDUPED)":"COMPLETED (SUCCESS)":s}function u(t){return t.isolatedserver+"/browse?namespace="+t.namespace+"&hash="+t.isolated}function _(t){if(!t)return{};t.tagMap={},t.tags=t.tags||[];for(const e of t.tags){const s=e.split(":",1)[0],n=e.substring(s.length+1);t.tagMap[s]=n}return y.forEach(e=>{Object(i.h)(t,e)}),t}function p(t){if(!t)return{};y.forEach(e=>{Object(i.h)(t,e)}),t.try_number&&(t.try_number=+t.try_number);const e=new Date;!t.duration&&"RUNNING"===t.state&&t.started_ts?t.duration=(e-t.started_ts)/1e3:!t.duration&&"BOT_DIED"===t.state&&t.started_ts&&t.abandoned_ts&&(t.duration=(t.abandoned_ts-t.started_ts)/1e3),t.human_duration=Object(i.d)(t.duration),"RUNNING"===t.state?t.human_duration+="*":"BOT_DIED"===t.state&&(t.human_duration+=" -- died");const s=t.started_ts||t.abandoned_ts||new Date;return t.created_ts?s<=t.created_ts?(t.pending=0,t.human_pending="0s"):(t.pending=(s-t.created_ts)/1e3,t.human_pending=Object(i.l)(t.created_ts,s)):(t.pending=0,t.human_pending=""),t.current_task_slice=parseInt(t.current_task_slice)||0,t}function f(t){if(!t||!t._request||!t._request.tagMap)return;const e=t._request.tagMap,s=e.milo_host;let n=e.log_location;if(n&&s){if(n=n.replace("logdog://",""),-1!==n.indexOf("${SWARMING_TASK_ID}")){if(!t._result||!t._result.run_id)return;n=n.replace("${SWARMING_TASK_ID}",t._result.run_id)}return s.replace("%s",n)}const i=t.server_details.display_server_url_template;return i&&t._taskId?i.replace("%s",t._taskId):void 0}function m(t,e){if(!e.created_ts)return"";const s=1e3*t.expiration_secs;return n.d(new Date(e.created_ts.getTime()+s))}function b(t){if(!t||!t.state)return"";const e=t.state;return r.b.has(e)?"exception":"BOT_DIED"===e?"bot_died":r.d.has(e)?"pending_task":"COMPLETED"===e&&t.failure?"failed_task":""}function g(t){return t&&t.costs_usd&&t.costs_usd.length?t.costs_usd[0].toFixed(4):0}function v(t){if(!t.created_ts)return"";const e=1e3*t.expiration_secs;return n.d(new Date(t.created_ts.getTime()+e))}function k(t,e){return t&&e&&-1!==t._currentSliceIdx&&t._currentSliceIdx!==e.current_task_slice?"inactive":""}function w(t){return 0===t.try_number}function E(t){return t&&"PENDING"!==t.state&&"NO_RESOURCE"!==t.state&&"CANCELED"!==t.state&&"EXPIRED"!==t.state}const y=["abandoned_ts","completed_ts","created_ts","modified_ts","started_ts"]},function(t,e,s){"use strict";s.d(e,"a",(function(){return r}));var n=s(9),i=s(2);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
</div>`,this,{eventContext:this})}attributeChangedCallback(t,e,s){this.render()}});var l=s(10),c=s(7),h=s(17);const u=document.createElement("template");u.innerHTML="\n<button class=toggle-button>\n  <menu-icon-sk>\n  </menu-icon-sk>\n</button>\n";const _=document.createElement("template");_.innerHTML="\n<div class=spinner-spacer>\n  <spinner-sk></spinner-sk>\n</div>\n";const p=document.createElement("template");p.innerHTML='\n<a target=_blank rel=noopener\n   href="https://bugs.chromium.org/p/chromium/issues/entry?components=Infra%3EPlatform%3ESwarming%3EWebUI&owner=kjlubick@chromium.org&status=Assigned">\n  <bug-report-icon-sk class=fab></bug-report-icon-sk>\n</a>',window.customElements.define("swarming-app",class extends HTMLElement{constructor(){super(),this._busyTaskCount=0,this._spinner=null,this._dynamicEle=null,this._auth_header="",this._profile={},this._server_details={server_version:"You must log in to see more details",bot_version:""},this._permissions={}}connectedCallback(){Object(n.a)(this,"client_id"),Object(n.a)(this,"testing_offline"),this._addHTML(),this.addEventListener("log-in",t=>{this._auth_header=t.detail.auth_header,this._profile=t.detail.profile,this._fetch()}),this.render()}static get observedAttributes(){return["client_id","testing_offline"]}get busy(){return!!this._busyTaskCount}get permissions(){return this._permissions}get profile(){return this._profile}get server_details(){return this._server_details}get client_id(){return this.getAttribute("client_id")}set client_id(t){return this.setAttribute("client_id",t)}get testing_offline(){return this.hasAttribute("testing_offline")}set testing_offline(t){t?this.setAttribute("testing_offline",!0):this.removeAttribute("testing_offline")}addBusyTasks(t){this._busyTaskCount+=t,this._spinner&&this._busyTaskCount>0&&(this._spinner.active=!0)}finishedTask(){this._busyTaskCount--,this._busyTaskCount<=0&&(this._busyTaskCount=0,this._spinner&&(this._spinner.active=!1),this.dispatchEvent(new CustomEvent("busy-end",{bubbles:!0})))}_addHTML(){const t=this.querySelector("header"),e=t&&t.querySelector("aside"),s=this.querySelector("footer");if(!(t&&e&&e.classList.contains("hideable")))return;let n=u.content.cloneNode(!0);t.insertBefore(n,t.firstElementChild),n=t.firstElementChild,n.addEventListener("click",t=>this._toggleMenu(t,e));const i=_.content.cloneNode(!0);t.insertBefore(i,e),this._spinner=t.querySelector("spinner-sk");const r=document.createElement("span");r.classList.add("grow"),t.appendChild(r),this._dynamicEle=document.createElement("div"),this._dynamicEle.classList.add("right"),t.appendChild(this._dynamicEle);const o=document.createElement("error-toast-sk");s.append(o);const a=p.content.cloneNode(!0);s.append(a)}_toggleMenu(t,e){e.classList.toggle("shown")}_fetch(){if(!this._auth_header)return;this._server_details={server_version:"<loading>",bot_version:"<loading>"};const t={headers:{authorization:this._auth_header}};this.addBusyTasks(1),fetch("/_ah/api/swarming/v1/server/details",t).then(l.a).then(t=>{this._server_details=t,this.render(),this.dispatchEvent(new CustomEvent("server-details-loaded",{bubbles:!0})),this.finishedTask()}).catch(t=>{403===t.status?(this._server_details={server_version:"User unauthorized - try logging in with a different account",bot_version:""},this.render()):(console.error(t),Object(a.a)(`Unexpected error loading details: ${t.message}`,5e3)),this.finishedTask()}),this._fetchPermissions(t)}_fetchPermissions(t,e){this.addBusyTasks(1);let s="/_ah/api/swarming/v1/server/permissions";return e&&(s+=`?${c.a(e)}`),fetch(s,t).then(l.a).then(t=>{this._permissions=t,this.render(),this.dispatchEvent(new CustomEvent("permissions-loaded",{bubbles:!0})),this.finishedTask()}).catch(t=>{403!==t.status&&(console.error(t),Object(a.a)(`Unexpected error loading permissions: ${t.message}`,5e3)),this.finishedTask()})}render(){var t;this._dynamicEle&&Object(o.d)((t=this,o.c`
<div class=server-version>
  Server:
  <a href=${Object(h.a)(function(t){if(!t||!t.server_version)return;const e=t.server_version.split("-");return 2===e.length?`https://chromium.googlesource.com/infra/luci/luci-py/+/${e[1]}`:void 0}(t._server_details))}>
