...
function versionLink(details) {
  ...
  versionString = html`<a href=${pantheonURL.concat(details.project_id, versionFilterPrefix, details.server_version, versionFilterPostfix)}>${details.server_version}</a>`;
