 ...
 *   that the app is busy (e.g. AJAX requests). Simply use the addBusyTasks()
...
window.customElements.define('swarming-app', class extends HTMLElement {
  ...
  /** @prop {boolean} busy Indicates if there any on-going tasks. This also mirrors
  *                   the status of the embedded spinner-sk. Read-only. */
  ...
  /**
   * Indicate there are some number of events the app is waiting on
  ...
  static get observedAttributes() {
    return ['client_id', 'testing_offline', 'busy'];
  }
