...
//===============TESTS START====================================
    ...
    describe('gpu bot with a running task', function() {
      ...
      it('renders all events in a table', function(done) {
        loggedInBotPage((ele) => {
          ...
          expect(cell(15, 0)).toMatchTextContent('About to restart: Updating to abcdoeraymeyouandme');
      ...
      it('renders some events in a table', function(done) {
        loggedInBotPage((ele) => {
          ...
          // row 0 is the header
          expect(cell(1, 0)).toMatchTextContent('About to restart: Updating to abcdoeraymeyouandme');
  ...
  describe('api calls', function() {
    ...
    it('makes auth\'d API calls when a logged in user views landing page', function(done) {
      ...
      loggedInBotPage((ele) => {
        let calls = fetchMock.calls(MATCHED, 'GET');
        expect(calls.length).toBe(2+3, '2 GETs from swarming-app, 2 from bot-page');
