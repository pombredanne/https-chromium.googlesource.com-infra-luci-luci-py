...
//===============TESTS START====================================
  ...
  describe('html structure', function() {
    ...
    fdescribe('when logged in as unauthorized user', function() {
      ...
      xit('does not display logs or task details', function(done) {
        loggedInBotPage((ele) => {
    ...
    describe('authorized user, but no bot id', function() {
      ...
      xit('does not display filters or tasks', function(done) {
        loggedInBotPage((ele) => {
          expect('todo').toBeFalsy();
          done();
        }, true);
