...
<tr class$="[[_classVersion(_server_details.bot_version,_bot.version)]]"
...
<tr title="The version the server expects the bot to be using.">
  ...
  <td colspan=2>${ele.server_details.bot_version && ele.server_details.bot_version.substring(0, 10)}</td>
</tr>
...
<swarming-app id=swapp
  ...
  <main>
    ...
    <div class="horizontal layout wrap content" ?hidden=${!ele.loggedInAndAuthorized || !ele._botId}>
      <div class=grow>
        <table>
