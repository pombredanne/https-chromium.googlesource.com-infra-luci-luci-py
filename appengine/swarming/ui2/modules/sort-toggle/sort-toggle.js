...
<arrow-drop-down-sk hidden?=${ele.key === ele.current && ele.direction === 'asc'}></arrow-drop-down-sk>
<arrow-drop-up-sk hidden?=${ele.key === ele.current && ele.direction === 'desc'}></arrow-drop-up-sk>
`
