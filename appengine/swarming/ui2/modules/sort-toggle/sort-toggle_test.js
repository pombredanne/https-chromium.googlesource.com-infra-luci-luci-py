...
//===============TESTS START====================================
  ...
  it('displays both arrows when current != key', function(done) {
    createElement((ele) => {
      ele.current = 'alpha';
      ele.key = 'beta';
      let arrow = ele.querySelector('arrow-drop-down-sk');
      expect(arrow).toBeTruthy();
      expect(arrow.attributes.hidden).toBeFalsy();
      arrow = ele.querySelector('arrow-drop-up-sk');
      expect(arrow).toBeTruthy();
      expect(arrow.attributes.hidden).toBeFalsy();
      done();
    });
  ...
  it('displays only one arrow when the active choice', function(done) {
    createElement((ele) => {
      ...
      ele.direction = 'desc';
      arrow = ele.querySelector('arrow-drop-down-sk');
      expect(arrow).toBeTruthy();
      expect(arrow.attributes.hidden).toBeFalsy();
      arrow = ele.querySelector('arrow-drop-up-sk');
      expect(arrow).toBeTruthy();
