...
//===============TESTS START====================================
  ...
  it('generates dialog-negative events for the cancel button', function(done) {
    createElement((ele) => {
      let btn = $$('.negative', ele);
      ele.addEventListener('dialog-negative', () => {
        done();
      });
      btn.click();
    });
  ...
  it('generates dialog-positive events for the ok button', function(done) {
    createElement((ele) => {
      let btn = $$('.positive', ele);
      ele.addEventListener('dialog-positive', () => {
        done();
      });
      btn.click();
    });
