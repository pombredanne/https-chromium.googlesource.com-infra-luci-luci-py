...
if (!mockAppGETs) {
  ...
  var toContainRegexMatcher = require('modules/test_util').toContainRegexMatcher;
}
...
describe('bot-list', function() {
  ...
  afterEach(function() {
    ...
    // Clear out any query params we might have to not confuse future
    // tests (which will read them in).
...
//===============TESTS START====================================
  ...
  describe('html structure', function() {
    ...
    describe('when logged in as user (not admin)', function() {
      ...
      describe('default landing page', function() {
        ...
        it('fills out the query params with the defaults', function(done) {
          loggedInBotlist((ele) => {
  ...
  describe('dynamic behavior', function() {
    ...
    it('reads some values from query params', function(done) {
      history.pushState(null, '', window.location.origin + window.location.pathname + '?'+
    ...
    it('updates query params on render()', function(done) {
      loggedInBotlist((ele) => {
  ...
  describe('api calls', function() {
    ...
    it('makes auth\'d API calls when a logged in user views landing page', function(done) {
      ...
      // TODO(kjlubick): Add one to check that query params are added.
    });
