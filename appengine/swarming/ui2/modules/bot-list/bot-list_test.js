      ...
      describe('default landing page', function() {
        ...
        it('shows the default set of columns', function(done) {
          loggedInBotlist((ele) => {
            ...
            expect(cell(1, 4).textContent).toContain('[available,too_hot,low_battery]');
        ...
        it('displays counts', function(done) {
          loggedInBotlist((ele) => {
            ...
            tds = queryTable.querySelectorAll('tr:first-child td');
            expect(tds).toBeTruthy();
            expect(tds.length).toBe(2);
            expect(tds[0]).toMatchTextContent('Displayed:');
            // TODO(kjlubick): Check for no link on tds[0]
            expect(tds[1]).toMatchTextContent('10');

            tds = queryTable.querySelectorAll('tr:nth-child(3) td');
            expect(tds).toBeTruthy();
            expect(tds.length).toBe(2);
            ...
            tds = queryTable.querySelectorAll('tr:nth-child(8) td');
            expect(tds).toBeTruthy();
            expect(tds.length).toBe(2);
  ...
  describe('dynamic behavior', function() {
    ...
    it('toggles fleet data visibility', function(done) {
      loggedInBotlist((ele) => {
        ...
        let showMore = $$('#fleet_header expand-more-icon-sk', ele);
        expect(showMore).toBeTruthy();
        let counts = $$('#fleet_counts');
        expect(counts).toHaveAttribute('hidden');

        showMore.click();
        showMore = $$('#fleet_header expand-more-icon-sk', ele);
        let showLess = $$('#fleet_header expand-less-icon-sk', ele);
        ...
        showLess.click();
        showMore = $$('#fleet_header expand-more-icon-sk', ele);
        showLess = $$('#fleet_header expand-less-icon-sk', ele);
