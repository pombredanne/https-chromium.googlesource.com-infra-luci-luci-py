...
import { aggregateTemps, attribute, botLink, column, colHeaderMap,
         devices, extraKeys, filterBots, fromDimension, fromState, listQueryParams,
...
<div class=options>
  ...
  <button @click=${(e) => alert('not implemented yet')}>DELETE ALL DEAD BOTS</button>
</div>
  ...
  <main>
    ...
    <div class=header>
      <div class=filter_box ?hidden=${!ele.loggedInAndAuthorized}>
        <!-- TODO(kjlubick): have something like sk-input -->
        <input class=search placeholder='Search colums and filters or supply a filter and press enter'></input>

        ${ele.loggedInAndAuthorized ? filters(ele): ''}

        ${ele.loggedInAndAuthorized ? options(ele): ''}
      </div>
      ...
      <div class=summary>
        ...
        <table>
          <tr>
            <td>All:</td><td>21000</td>
          </tr>
          <tr>
            <td>Alive:</td><td>210</td>
          </tr>
          <tr>
            <td>Busy:</td><td>210</td>
          </tr>
          <tr>
            <td>Idle:</td><td>210</td>
          </tr>
          <tr>
            <td>Dead:</td><td>210</td>
          </tr>
          <tr>
            <td>Quarantined:</td><td>210</td>
          </tr>
          <tr>
            <td>Maintenance:</td><td>210</td>
          </tr>
        </table>
