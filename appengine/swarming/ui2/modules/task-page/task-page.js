...
<div class=reproduce>
  ...
  <div class="code bottom_space" ?hidden=${!hasIsolated}>
    # (if needed) cipd install infra/tools/luci/isolated/mac-amd64 -root your_cipd_bin<br>
    ./your_cipd_bin/isolated download -I ${ref.isolatedserver} --namespace ${ref.namespace}
