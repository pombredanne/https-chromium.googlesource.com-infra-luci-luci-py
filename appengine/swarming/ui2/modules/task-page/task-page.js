...
import { canRetry, cipdLink, durationChart, hasRichOutput, humanState,
         ...
         richLogsLink, sliceScheduleDeadline, stateClass, taskCost,
         taskScheduleDeadline, taskInfoClass, wasDeduped,
...
<tr>
  <td>Slice Schedule Deadline</td>
  <td>${sliceScheduleDeadline(currentSlice, request)}</td>
</tr>
<tr>
  <td>User</td>
  <td>${request.user || '--'}</td>
  ...
  <table class="task-info task-timing left">
    <tbody>
      ...
      <tr>
        ...
        <td>${taskScheduleDeadline(request)}</td>
      </tr>
