...
import { cipdLink, getRichLogsLink, hasRichOutput, humanState, isolateLink, isSummaryTask,
         parseRequest, parseResult, sliceExpires, taskCost, taskExpires,
...
<div class="horizontal layout">
  <div class=output-picker>
    <div class=tab ?selected=${!ele._showRawOutput && hasRichOutput(ele)}
      ...
      <a rel=noopener target=_blank href=${ifDefined(getRichLogsLink(ele))}>
        Rich Output
      </a>
    </div>
    <div class=tab ?selected=${ele._showRawOutput || !hasRichOutput(ele)}
    ...
    <checkbox-sk ?checked=${ele._wideLogs} @click=${ele._toggleWidth}></checkbox-sk>
...
<div class="richLogs tabbed">
  ...
  return html`
<iframe id=richLogsFrame class="milo tabbed" src=${ifDefined(getRichLogsLink(ele))}></iframe>
`;
}
