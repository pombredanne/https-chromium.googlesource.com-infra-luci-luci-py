  ...
  describe('dynamic behavior', function() {
    ...
    it('can stable sort', function(done) {
      loggedInTasklist((ele) => {
        ...
        expect(actualIDOrder).toEqual(['41e0284bc3ef4f10', '41e023035ecced10',
          ...
          '41dfa79d3bf29010', '41df677202f20310', '41e020504d0a5119',
        ...
        expect(actualPoolOrder).toEqual(['Chrome', 'Chrome', 'Chrome',
          ...
          'Skia', 'Skia', 'Skia', 'Skia', 'chromium.tests', 'fuchsia.tests',
          'fuchsia.tests', 'luci.chromium.ci', 'luci.chromium.ci',
          'luci.chromium.ci', 'luci.fuchsia.try', 'luci.fuchsia.try']);
        done();
      });
    });
    ...
    it('can sort durations correctly', function(done) {
      loggedInTasklist((ele) => {
        ...
        expect(actualPendingOrder).toEqual(['0s', '0s', '0.63s', '0.66s', '0.72s',
          '2.35s', '2.36s', '2.58s', '5.74s', '8.21s', '24.58s', '1m 11s', '1m 17s',
          '5m  5s', '5m 36s', '11m 28s', '14m 54s*', '14m 55s*', '27m 55s',
          '--', '--']);
        done();
      });
    });
