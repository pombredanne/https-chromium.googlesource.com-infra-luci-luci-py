...
class Test(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.dimensions[u'server_version'] = [u'1']
  ...
  def test_cancel_pending(self):
    ...
    actual, _ = self.client.task_collect(task_id, timeout=0)
    self.assertEqual(
  ...
  def test_cancel_running(self):
    ...
    self._run_isolated(
        hello_world, 'cancel_running', ['--', '${ISOLATED_OUTDIR}'],
