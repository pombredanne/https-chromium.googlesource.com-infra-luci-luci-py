...
class SwarmingClient(object):
  ...
  def task_trigger_post(self, request):
    """Triggers a task with the very raw RPC and return the task id."""
...
class Test(unittest.TestCase):
  ...
  def test_task_slice_fallback(self):
    # Trigger a task that couldn't be run, but its fallback could.
    # The very minimal task request that will be allowed.
    request = {
