...
class SwarmingClient(object):
  ...
  def retrieve(self, isolated_hash, dst):
    """Retrieves an isolated content."""
    args = [
      '--namespace', self._namespace,
      '-s', isolated_hash,
      '-t', dst,
...
class Test(unittest.TestCase):
  ...
  def test_isolated(self):
    ...
    # TODO(maruel): Fetch isolated from outputs_ref to calculate its size.
    ...
    self.assertOutputsRef(outputs_ref)
  ...
  def assertResults(self, expected, result, deduped=False):
    """Compares the outputs of a swarming tasks."""
