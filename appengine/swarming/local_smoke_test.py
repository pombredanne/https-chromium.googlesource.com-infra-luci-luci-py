...
class Test(unittest.TestCase):
  ...
  def test_priority(self):
    ...
    try:
      ...
      # This is the order of the priorities used for each task triggered.
    ...
    # LOL.
    expected = ['1-p8', '2-p6', '4-p8', '0-p9', '3-p7']
    expected = ['2-p6', '1-p8', '0-p9', '3-p7', '4-p8']
    expected = ['2-p6', '3-p7', '0-p9', '1-p8', '4-p8']
    expected = ['2-p6', '3-p7', '0-p9', '4-p8', '1-p8']
    expected = ['2-p6', '3-p7', '1-p8', '4-p8', '0-p9']
    expected = ['3-p7', '4-p8', '0-p9', '2-p6', '1-p8']
