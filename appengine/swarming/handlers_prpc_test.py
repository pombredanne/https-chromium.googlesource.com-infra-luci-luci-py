...
class BotServicePrpcTest(PrpcTest):
  ...
  def setUp(self):
    ...
    self.service = "swarming_api.v1.BotService"
  ...
  def test_bot_get(self):
    ...
    actual_info = swarming_api_pb2.BotInfoResponse()
  ...
  def test_get_deleted_bot(self):
    ...
    ghost_bot = swarming_api_pb2.BotInfoResponse()
  ...
  def test_events(self):
    ...
    response = self.post_prpc("ListBotEvents", request)
    dimensions = [
        {
            u'key': u'id',
            u'value': [u'bot1']
  ...
  def test_terminate_admin(self):
    ...
    self.set_as_admin()
    request = swarming_api_pb2.BotRequest(bot_id="bot1")
    response = self.post_prpc('TerminateBot', request)
  ...
  def test_terminate_user(self):
    ...
    self.mock_auth_db([])
    request = swarming_api_pb2.BotRequest(bot_id="bot1")
    response = self.post_prpc('TerminateBot', request, expect_errors=True)
    expected = cgi.escape(
        'user "user@example.com" does not have permission "swarming.pools.terminateBot"',
        quote=True)
