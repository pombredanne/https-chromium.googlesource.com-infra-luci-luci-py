...
class TaskServicePrpcTest(PrpcTest):
  ...
  def test_stdout_ok(self):
    ...
    expected = swarming_pb2.TaskOutputResponse(
        output=b'rÉsult string', state=swarming_pb2.TaskState.COMPLETED)
    ...
    expected = swarming_pb2.TaskOutputResponse(
        output=b'É', state=swarming_pb2.TaskState.COMPLETED)
    self.assertEqual(expected, actual)
    ...
    _decode(response.body, actual)
    expected = swarming_pb2.TaskOutputResponse(
        output=b'sult ', state=swarming_pb2.TaskState.COMPLETED)
    self.assertEqual(expected, actual)
