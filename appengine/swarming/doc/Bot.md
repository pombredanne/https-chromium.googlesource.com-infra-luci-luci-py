...
*   If the grace period expired and the child process still hasn't exited, a
    second SIGTERM is sent, and the process is given an additional
    (grace_period*20%) seconds of "mercy" to terminate.
...
a similar dance when they receive SIGTERM, and switch a second (more
