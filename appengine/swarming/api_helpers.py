...
def process_task_request(tr, template_apply, enable_resultdb):
  ...
  Raises:
    handlers_exceptions.BadTaskRequestException: if the request is missing
  ...
  try:
    ...
    raise handlers_exceptions.BadTaskRequestException(e.message)
  ...
  if enable_resultdb and not tr.realms_enabled:
    raise handlers_exceptions.BadTaskRequestException(
