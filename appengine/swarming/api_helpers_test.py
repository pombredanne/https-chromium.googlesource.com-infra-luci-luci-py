...
class TestCheckIdenticalRequest(test_case.TestCase):
  ...
  def test_cache_hit(self):
    ...
    self.assertEqual(
        'ok', api_helpers.cache_request('test_request', request_uuid, request))
  ...
  def test_namespace(self):
    ...
    self.assertEqual(
        'ok', api_helpers.cache_request('test_request_1', request_uuid,
                                        request1))
    ...
    self.assertEqual(
        'great',
        api_helpers.cache_request('test_request_2', request_uuid, request2))
