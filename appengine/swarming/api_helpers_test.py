...
class TestProcessTaskRequest(test_case.TestCase):
  ...
  def test_process_task_request_BadTaskRequest(self):
    ...
    with self.assertRaisesRegexp(handlers_exceptions.BadTaskRequestException,
                                 'missing expiration_secs'):
      api_helpers.process_task_request(tr, task_request.TEMPLATE_AUTO, True)
  ...
  def test_process_task_request_service_account_legacy(self):
    ...
    api_helpers.process_task_request(tr, task_request.TEMPLATE_AUTO, False)
