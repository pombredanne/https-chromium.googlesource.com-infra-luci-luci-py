...
_RUNTASKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\030\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start_build_task_token', full_name='buildbucket.v2.RunTaskRequest.start_build_task_token', index=17,
...
_RUNTASKREQUEST.fields_by_name['secrets']._options = None
_RUNTASKREQUEST.fields_by_name['pubsub_topic']._options = None
