...
class Test(unittest.TestCase):
  ...
  def test_is_valid_package_name_template(self):
    self.assertTrue(cipd.is_valid_package_name_template('foo'))
    self.assertTrue(cipd.is_valid_package_name_template('foo${bar}'))
    self.assertTrue(cipd.is_valid_package_name_template('infra/tools/cipd/${platform}'))
    self.assertFalse(cipd.is_valid_package_name_template('foo{'))
    self.assertFalse(cipd.is_valid_package_name_template('foo{bar}'))
