...
def _show_all_stacktraces_and_exit():
  """Prints to stderr the stack of every threads and exit."""
...
class Timer(events.Plugin):
  ...
  def startTest(self, event):
    self._timer = threading.Timer(30, _show_all_stacktraces_and_exit)
    self._timer.start()
