  ...
  def set_default_version(self, version, services=None, roll_options=None):
    ...
    print "Monitor logs for new version here:", (
      self.app_id.join([
        ...
        '&minLogLevel=0&expandAll=false&customFacets=&limitCustomFacetWidth=true&interval=NO_LIMIT&resource=gae_app%2Fmodule_id%2Fbackend%2Fversion_id%2F'+version+'&logName=projects%2F',
        '%2Flogs%2Fappengine.googleapis.com%252Frequest_log&advancedFilter=resource.type%3D%22gae_app%22%0Aresource.labels.version_id%3D%22'+version+'%22%0AlogName%3D%22projects%2F',
