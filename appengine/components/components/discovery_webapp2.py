...
def _get_schemas(types):
  ...
  # Desired invariant: seen contains elements which have *ever* been in types.
  # This invariant allows us to extend types mid-loop to add more elements to
  # process without unnecessarily processing the same element twice. We achieve
