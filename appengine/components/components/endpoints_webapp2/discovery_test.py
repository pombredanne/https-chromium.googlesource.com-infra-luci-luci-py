...
class Service(remote.Service):
  ...
  def resource_method_a(self, _):
    """An HTTP POST method belonging to a resource."""
    return Message()

  @endpoints.method(Message, Message, name='resource.subresource.b')
  def resource_method_b(self, _):
    """An HTTP POST method belonging to a sub-resource."""
    return Message()
    ...
    expected = (
      ...
      # resources
      {
        'resource': {
          'methods': {
            'a': {
              'description': 'An HTTP POST method belonging to a resource.',
              'httpMethod': 'POST',
          ...
          'resources': {
            'subresource': {
              'methods': {
                'b': {
              'description': 'An HTTP POST method belonging to a sub-resource.',
              'httpMethod': 'POST',
