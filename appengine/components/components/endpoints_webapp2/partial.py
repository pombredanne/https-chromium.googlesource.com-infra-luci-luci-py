...
def _apply(response, mask):
  """Applies the given partial response mask to the given response.

  Args:
    response: A dict to be updated in place.
    mask: A partial response dict as returned by _parse. May be modified,
