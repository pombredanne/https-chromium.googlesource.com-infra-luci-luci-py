...
_PROJECTCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='config.ProjectCfg.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='access',
            full_name='config.ProjectCfg.access',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_REFSCFG_REF = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='config.RefsCfg.Ref.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='config_path',
            full_name='config.RefsCfg.Ref.config_path',
            index=1,
            number=3,
            type=9,
            cpp_type=9,
...
ProjectCfg = _reflection.GeneratedProtocolMessageType(
    'ProjectCfg',
    (_message.Message,),
    dict(
...
RefsCfg = _reflection.GeneratedProtocolMessageType(
    'RefsCfg',
    (_message.Message,),
    dict(
