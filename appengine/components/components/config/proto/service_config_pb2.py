...
_ACLCFG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='reimport_group', full_name='luci.config.AclCfg.reimport_group', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='readers_group', full_name='luci.config.AclCfg.readers_group', index=5,
