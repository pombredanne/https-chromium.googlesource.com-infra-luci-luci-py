...
_CONFIGSETLOCATION_STORAGETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name='UNSET', index=0, number=0, serialized_options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='GITILES',
            index=1,
...
_VALIDATIONRESPONSEMESSAGE_SEVERITY = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='INFO', index=2, number=20, serialized_options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='WARNING',
            index=3,
...
_CONFIGSETLOCATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='url',
            full_name='config.ConfigSetLocation.url',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='storage_type',
            full_name='config.ConfigSetLocation.storage_type',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
...
_IDENTITYCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='config.IdentityConfig.service_account_email',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PROJECT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='config.Project.config_location',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='config.Project.identity_config',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PROJECTSCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='projects',
            full_name='config.ProjectsCfg.projects',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_SERVICE_JWTAUTH = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='audience',
            full_name='config.Service.JWTAuth.audience',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_SERVICE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='owners',
            full_name='config.Service.owners',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='config_location',
            full_name='config.Service.config_location',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='metadata_url',
            full_name='config.Service.metadata_url',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='access',
            full_name='config.Service.access',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='jwt_auth',
            full_name='config.Service.jwt_auth',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
...
_SERVICEDYNAMICMETADATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='version',
            full_name='config.ServiceDynamicMetadata.version',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='validation',
            full_name='config.ServiceDynamicMetadata.validation',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SERVICESCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='services',
            full_name='config.ServicesCfg.services',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ACLCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='project_access_group',
            full_name='config.AclCfg.project_access_group',
            index=0,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='config.AclCfg.service_access_group',
            index=1,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='admin_group',
            full_name='config.AclCfg.admin_group',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='config.AclCfg.validation_group',
            index=3,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='reimport_group',
            full_name='config.AclCfg.reimport_group',
            index=4,
            number=6,
            type=9,
            cpp_type=9,
...
_IMPORTCFG_GITILES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='fetch_log_deadline',
            full_name='config.ImportCfg.Gitiles.fetch_log_deadline',
            index=0,
            number=1,
            type=5,
            cpp_type=1,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='fetch_archive_deadline',
            full_name='config.ImportCfg.Gitiles.fetch_archive_deadline',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='project_config_default_ref',
            full_name='config.ImportCfg.Gitiles.project_config_default_ref',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='project_config_default_path',
            full_name='config.ImportCfg.Gitiles.project_config_default_path',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='ref_config_default_path',
            full_name='config.ImportCfg.Gitiles.ref_config_default_path',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_SCHEMASCFG_SCHEMA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='config.SchemasCfg.Schema.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='url',
            full_name='config.SchemasCfg.Schema.url',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SCHEMASCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='schemas',
            full_name='config.SchemasCfg.schemas',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CONFIGPATTERN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='config_set',
            full_name='config.ConfigPattern.config_set',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='path',
            full_name='config.ConfigPattern.path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_VALIDATOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='patterns',
            full_name='config.Validator.patterns',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='url',
            full_name='config.Validator.url',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_VALIDATIONREQUESTMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='config_set',
            full_name='config.ValidationRequestMessage.config_set',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='path',
            full_name='config.ValidationRequestMessage.path',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='content',
            full_name='config.ValidationRequestMessage.content',
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
_VALIDATIONRESPONSEMESSAGE_MESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='path',
            full_name='config.ValidationResponseMessage.Message.path',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='severity',
            full_name='config.ValidationResponseMessage.Message.severity',
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='text',
            full_name='config.ValidationResponseMessage.Message.text',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_VALIDATIONRESPONSEMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='messages',
            full_name='config.ValidationResponseMessage.messages',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
    ...
    extensions=[],
    nested_types=[
        _VALIDATIONRESPONSEMESSAGE_MESSAGE,
    ],
    enum_types=[
...
_CONFIGSETLOCATION.fields_by_name[
    'storage_type'].enum_type = _CONFIGSETLOCATION_STORAGETYPE
...
_VALIDATIONRESPONSEMESSAGE_MESSAGE.fields_by_name[
    'severity'].enum_type = _VALIDATIONRESPONSEMESSAGE_SEVERITY
_VALIDATIONRESPONSEMESSAGE_MESSAGE.containing_type = _VALIDATIONRESPONSEMESSAGE
_VALIDATIONRESPONSEMESSAGE.fields_by_name[
    'messages'].message_type = _VALIDATIONRESPONSEMESSAGE_MESSAGE
...
DESCRIPTOR.message_types_by_name[
    'ServiceDynamicMetadata'] = _SERVICEDYNAMICMETADATA
...
DESCRIPTOR.message_types_by_name[
    'ValidationRequestMessage'] = _VALIDATIONREQUESTMESSAGE
DESCRIPTOR.message_types_by_name[
    'ValidationResponseMessage'] = _VALIDATIONRESPONSEMESSAGE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ConfigSetLocation = _reflection.GeneratedProtocolMessageType(
    'ConfigSetLocation',
    (_message.Message,),
    dict(
...
IdentityConfig = _reflection.GeneratedProtocolMessageType(
    'IdentityConfig',
    (_message.Message,),
    dict(
...
ProjectsCfg = _reflection.GeneratedProtocolMessageType(
    'ProjectsCfg',
    (_message.Message,),
    dict(
...
Service = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        JWTAuth=_reflection.GeneratedProtocolMessageType(
            'JWTAuth',
            (_message.Message,),
            dict(
...
ServiceDynamicMetadata = _reflection.GeneratedProtocolMessageType(
...
ServicesCfg = _reflection.GeneratedProtocolMessageType(
    'ServicesCfg',
    (_message.Message,),
    dict(
...
AclCfg = _reflection.GeneratedProtocolMessageType(
    'AclCfg',
    (_message.Message,),
    dict(
        DESCRIPTOR=_ACLCFG,
...
ImportCfg = _reflection.GeneratedProtocolMessageType(
    'ImportCfg',
    (_message.Message,),
    dict(
        Gitiles=_reflection.GeneratedProtocolMessageType(
            'Gitiles',
            (_message.Message,),
            dict(
...
SchemasCfg = _reflection.GeneratedProtocolMessageType(
    'SchemasCfg',
    (_message.Message,),
    dict(
...
ConfigPattern = _reflection.GeneratedProtocolMessageType(
    'ConfigPattern',
    (_message.Message,),
    dict(
...
ValidationRequestMessage = _reflection.GeneratedProtocolMessageType(
...
ValidationResponseMessage = _reflection.GeneratedProtocolMessageType(
