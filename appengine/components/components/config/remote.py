...
#
# The threshold is random to avoid a stamped, see _maybe_update_last_access_ts.
UPDATE_LAST_ACCESS_TIME_MIN = datetime.timedelta(hours=20)
UPDATE_LAST_ACCESS_TIME_MAX = datetime.timedelta(hours=28)
...
def _maybe_update_last_access_ts(elapsed):
  ...
  # `delta * beta` is somewhat arbitrarily picked to be 5 min.
