...
class DiscoveryWebapp2TestCase(test_case.TestCase):
  ...
  def test_add_methods(self):
    """Tests discovery_webapp2.add_methods."""
    expected = {
      'methods': {
        'get_method': {
    ...
    self.assertEqual(discovery_webapp2.add_methods({}, Service), expected)

  def test_add_schemas(self):
    """Tests for discovery_webapp2.add_schemas."""
    expected = {
      'schemas': {
    ...
    self.assertEqual(discovery_webapp2.add_schemas({}, [Parent]), expected)
