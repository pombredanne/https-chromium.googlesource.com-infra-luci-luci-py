...
class UtilsTest(test_case.TestCase):
  ...
  def test_cache_with_expiration(self):
    ...
    self.assertEqual(3, do_work().get_result())
    self.assertEqual(3, do_work().get_result())
