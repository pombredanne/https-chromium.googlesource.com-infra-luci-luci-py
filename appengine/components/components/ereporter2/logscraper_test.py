...
class Ereporter2LogscraperTest(test_case.TestCase):
  ...
  def test_silence(self):
    ...
    self.assertEqual(False,
                     logscraper._should_ignore_error_category(None, category))
    ...
    m = models.ErrorReportingMonitoring(
        ...
        silenced=True)
    self.assertEqual(True, logscraper._should_ignore_error_category(
        m, category))
  ...
  def test_silence_until(self):
    ...
    self.assertEqual(False, logscraper._should_ignore_error_category(
        m, category))
