...
class ProcessedTraceback(object):
  ...
  def render_as_html(self, full=False):
    ...
    return u'%s\n\n<!--\n%s\n-->' % (render_traceback(
        self, full=full), self.render_as_text().decode('utf-8', 'replace'))
  ...
  try:
    ...
    if PY2:
      code = CodeType(0, code.co_nlocals, code.co_stacksize, code.co_flags,
                      ...
                      code.co_varnames, filename, location, code.co_firstlineno,
                      code.co_lnotab, (), ())
    else:
      code = CodeType(0, code.co_kwonlyargcount, code.co_nlocals,
                      code.co_stacksize, code.co_flags, code.co_code,
                      code.co_consts, code.co_names, code.co_varnames, filename,
...
def _init_ugly_crap():
  ...
  _Traceback._fields_ = [('tb_next', ctypes.POINTER(_Traceback)),
                         ...
                         ('tb_lasti', ctypes.c_int), ('tb_lineno',
                                                      ctypes.c_int)]
