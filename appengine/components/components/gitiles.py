...
def inject_netargs(method):
  """Decorator to forward Location.netargs into underlying net library."""
...
class Location(LocationTuple):
  ...
  @classmethod
  def from_dict(cls, d, netargs=None):
  ...
  @classmethod
  def parse(cls, url, treeishes=None, netargs=None):
  ...
  @classmethod
  def parse_resolve(cls, url, netargs=None):
