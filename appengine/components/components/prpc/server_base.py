...
class ServerBase(object):
  ...
  def _routes_handle(self, context, service, method):
  ...
  def _default_routes_options_request_response(self, request, response):
  ...
  def _default_routes_post_request_response(self, service, method, request,
                                            response):
    ...
    Returns:
      response: response body to be set to actual response
    """
    context = ServicerContext()
    content = self._routes_handle(context, service, method)
    origin = request.headers.get('Origin')
    if origin:
      response.headers['Access-Control-Allow-Origin'] = origin
      response.headers['Vary'] = 'Origin'
      response.headers['Access-Control-Allow-Credentials'] = 'true'
    self.set_response_status(self._PRPC_TO_HTTP_STATUS[context._code])
