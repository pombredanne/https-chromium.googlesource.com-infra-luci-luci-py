...
class ServerBase(object):
  ...
  def _post_handler(self, service, method, request, response):
    ...
    if origin:
      ...
      response.headers['Vary'] = 'Origin'
      response.headers['Access-Control-Allow-Credentials'] = 'true'
    self._response_status_write(response,
                                self._PRPC_TO_HTTP_STATUS[context._code])
    ...
    if content is not None:
      ...
      self._response_body_writer(response, body=content)
      ...
      self._response_body_writer(response, body=context._details)

  # pylint: disable=unused-argument
  def _response_body_writer(self, response, body):
    raise NotImplementedError("response body writer must be implemented")

  # pylint: disable=unused-argument
  def _response_status_write(self, response, status):
    raise NotImplementedError("response status writer must be implemented")
