...
import logging
from components.prpc.server import PRPC_TO_HTTP_STATUS
from components.prpc.server import HandlerCallDetails
...
class FlaskServerHandler(object):
  ...
  def post(self, service, method):
    ...
    self.response.status_code = PRPC_TO_HTTP_STATUS[context._code]
