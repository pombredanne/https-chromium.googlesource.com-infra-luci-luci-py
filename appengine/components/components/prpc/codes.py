...
class StatusCode(StatusCodeBase):
  ...
  def to_http_code(status_code):
    ...
    if httpCode == None:
        raise ValueError("%s is not a valid Status", status_code)
    else:
        return httpCode
...
_PRPC_TO_HTTP_STATUS = {
    ...
    StatusCode.UNKNOWN: httplib.BAD_REQUEST,
    ...
    StatusCode.ABORTED: httplib.BAD_REQUEST,    
    ...
    StatusCode.DATA_LOSS: httplib.BAD_REQUEST,    
