...
# A list of HTTP headers whose values is propagates as invocation_metadata.
_RECOGNIZED_METADATA_HEADERS = (
  'Authorization',
)
    ...
    class Handler(webapp2.RequestHandler):
      ...
      def _handle(self, context, service, method):
        ...
        call_details = HandlerCallDetails(
            ...
            invocation_metadata=[
                (k, self.request.headers[k])
                for k in _RECOGNIZED_METADATA_HEADERS
