...
from components.prpc import headers, encoding
    ...
    class Handler(webapp2.RequestHandler):
      ...
      def post(self, service, method):
        ...
        try:
          ...
          self.response.out.write(e.message.encode('utf-8'))
          return

        content = self._handle(context, service, method, content_type, accept)
        ...
        if content is not None:
          ...
          # Default webapp2 content type is text/html utf-8 encoded.
          self.response.out.write(context.details)
        return self.response

      def _handle(self, context, service, method, content_type, accept):
        ...
        Args:
          ...
          service: the service being targeted by this pRPC call.
          method: the method being invoked by this pRPC call.
          content_type: a string content type used to choose a decoder.
          accept: a string content type used to choose an encoder.
        ...
        try:
          ...
          logging.exception('Service implementation threw an exception: %s' % str(e))
