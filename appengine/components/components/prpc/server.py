  ...
  def _handler(self):
    ...
    class Handler(webapp2.RequestHandler):
      ...
      def post(self, service, method):
        ...
        context, content, accept = self._handle(service, method)
        ...
        if content is not None:
          ...
          self.response.out.write(context.details.encode('utf-8'))
        return self.response

      def _handle(self, service, method):
        ...
        Returns:
          context: a ServicerContext containing exit code, details, timeout, and
            other metadata.
