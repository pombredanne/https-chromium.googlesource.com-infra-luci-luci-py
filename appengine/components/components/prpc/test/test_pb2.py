...
_ECHORESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='response',
            full_name='test.EchoResponse.response',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
GiveRequest = _reflection.GeneratedProtocolMessageType(
    'GiveRequest',
    (_message.Message,),
    dict(
...
TakeResponse = _reflection.GeneratedProtocolMessageType(
    'TakeResponse',
    (_message.Message,),
    dict(
