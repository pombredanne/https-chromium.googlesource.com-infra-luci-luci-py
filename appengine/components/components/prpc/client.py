...
Request = collections.namedtuple('Request', [
    ...
    'service_account_key',
    # delegation_token: delegation token returned by components.auth.delegate.
    'delegation_token',
...
def new_request(
    ...
    **kwargs):
  """Creates a Request object. Provides default for optional fields."""
  ret = Request(
      hostname=hostname,
      insecure=False,
...
def rpc_async(req):
  ...
  headers['Content-Type'] = binary_mime_type
  headers['Accept'] = binary_mime_type
