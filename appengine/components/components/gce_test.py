...
class GceTest(test_case.TestCase):
  ...
  def test_get_instance(self):
    self.mock_requests([
        (
            {
                'url': 'https://www.googleapis.com/compute/v1/projects/123'
  ...
  def test_set_metadata(self):
    ...
    op = gce.Project('123').set_metadata('zone-id', 'inst_id', 'fingerprint', [{
        'key': 'k',
        'value': 'v'
    }])
  ...
  def test_get_network_interfaces(self):
    ...
    self.assertEqual(
        expected_interfaces_int,
        gce.get_network_interfaces('project', 'global/networks/default', False))
    self.assertEqual(
        expected_interfaces_ext,
        gce.get_network_interfaces('project', 'global/networks/default', True))
    expected_interfaces_int = [{
        'network': gce.get_network_url('project', 'default')
    }]
  ...
  def test_extract_zone(self):
    self.assertEqual(
        'us-central1-a',
        gce.extract_zone('https://www.googleapis.com/compute/v1/projects'
  ...
  def test_extract_region(self):
    self.assertEqual(
        'us-central1',
        gce.extract_region('https://www.googleapis.com/compute/v1/projects'
