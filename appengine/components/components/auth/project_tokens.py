...
def project_token_async(
  ...
  params = {
    ...
    'auth_request_func':auth_request_func,
    'min_validity_duration_sec':min_validity_duration_sec,
    'tags':tags,
    'token_server_url':token_server_url,
  }

  logging.info('project_token_async called with params: %s '%params)
  ...
  actual_validity_duration_sec = (
      datetime.datetime.fromtimestamp(expiry) - utils.utcnow()).seconds
