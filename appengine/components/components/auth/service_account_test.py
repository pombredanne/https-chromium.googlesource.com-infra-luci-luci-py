...
class GetAccessTokenTest(test_case.TestCase):
  ...
  def test_parse_rfc3339_omit_nanos(self):
    self.assertEqual(1412262083, service_account._parse_rfc3339_utc_omit_nanos('2014-10-02T15:01:23.045123456Z'))
    self.assertEqual(559011600, service_account._parse_rfc3339_utc_omit_nanos('1987-09-19T01:00:00.000000000Z'))
  ...
  def test_get_access_token_async(self):
    ...
    def urlfetch_mock(**kwargs):
      ...
      mock_dict = {
        "https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/" : Response({
    ...
    self.mock(service_account, 'get_access_token_async', get_access_token_async_mock)
    ...
    res = service_account.get_access_token_async(["c"], service_account_key=None, act_as="foo@example.com").get_result()
    self.assertEqual(
        {
