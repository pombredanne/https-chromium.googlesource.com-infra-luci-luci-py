...
class RealmStringsTest(test_case.TestCase):
  ...
  def test_validate_realm_name(self):
    self.assertTrue(api.validate_realm_name('proj:realm'))
    self.assertTrue(api.validate_realm_name('proj:@root'))
    self.assertTrue(api.validate_realm_name('proj:@legacy'))
