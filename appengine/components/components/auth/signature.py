...
@utils.cache_with_expiration(21600)
def get_google_oauth2_certs():
  """Returns CertificateBundle with Google's public OAuth2 certificates.

  They are rotated relatively infrequently, so we cache them for 6 hours.
  """
  return CertificateBundle(_fetch_certs_from_json(_GOOGLE_OAUTH2_CERTS_URL))
