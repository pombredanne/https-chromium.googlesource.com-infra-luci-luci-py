...
var beatifyPrincipalList = function(list) {
...
var renderListing = function(group, listing, $element) {
  ...
  // Beatify strings by stripping default 'user:' prefix.
  beatifyPrincipalList(listing.members);
  beatifyPrincipalList(listing.globs);
