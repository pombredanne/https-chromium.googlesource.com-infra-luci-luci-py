...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_options=_b(
        'Z:go.chromium.org/luci/server/auth/service/protocol;protocol'),
    serialized_pb=_b(
    ...
    dependencies=[
        components_dot_auth_dot_proto_dot_realms__pb2.DESCRIPTOR,
    ])
...
_SERVICELINKTICKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='primary_id',
            full_name='components.auth.ServiceLinkTicket.primary_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='primary_url',
            full_name='components.auth.ServiceLinkTicket.primary_url',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='generated_by',
            full_name='components.auth.ServiceLinkTicket.generated_by',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='ticket',
            full_name='components.auth.ServiceLinkTicket.ticket',
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_SERVICELINKREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ticket',
            full_name='components.auth.ServiceLinkRequest.ticket',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='replica_url',
            full_name='components.auth.ServiceLinkRequest.replica_url',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='initiated_by',
            full_name='components.auth.ServiceLinkRequest.initiated_by',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_AUTHGROUP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='components.auth.AuthGroup.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='members',
            full_name='components.auth.AuthGroup.members',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='globs',
            full_name='components.auth.AuthGroup.globs',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='nested',
            full_name='components.auth.AuthGroup.nested',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='description',
            full_name='components.auth.AuthGroup.description',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='created_ts',
            full_name='components.auth.AuthGroup.created_ts',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='created_by',
            full_name='components.auth.AuthGroup.created_by',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='modified_ts',
            full_name='components.auth.AuthGroup.modified_ts',
            index=7,
            number=8,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='modified_by',
            full_name='components.auth.AuthGroup.modified_by',
            index=8,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='owners',
            full_name='components.auth.AuthGroup.owners',
            index=9,
            number=10,
            type=9,
            cpp_type=9,
...
_AUTHIPWHITELIST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='components.auth.AuthIPWhitelist.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='subnets',
            full_name='components.auth.AuthIPWhitelist.subnets',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='description',
            full_name='components.auth.AuthIPWhitelist.description',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='created_ts',
            full_name='components.auth.AuthIPWhitelist.created_ts',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='created_by',
            full_name='components.auth.AuthIPWhitelist.created_by',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='modified_ts',
            full_name='components.auth.AuthIPWhitelist.modified_ts',
            index=5,
            number=6,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='modified_by',
            full_name='components.auth.AuthIPWhitelist.modified_by',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
...
_AUTHIPWHITELISTASSIGNMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='identity',
            full_name='components.auth.AuthIPWhitelistAssignment.identity',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='ip_whitelist',
            full_name='components.auth.AuthIPWhitelistAssignment.ip_whitelist',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='comment',
            full_name='components.auth.AuthIPWhitelistAssignment.comment',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='created_ts',
            full_name='components.auth.AuthIPWhitelistAssignment.created_ts',
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='created_by',
            full_name='components.auth.AuthIPWhitelistAssignment.created_by',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
...
_AUTHDB = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.AuthDB.oauth_client_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.AuthDB.oauth_client_secret',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='oauth_additional_client_ids',
            full_name='components.auth.AuthDB.oauth_additional_client_ids',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='groups',
            full_name='components.auth.AuthDB.groups',
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='ip_whitelists',
            full_name='components.auth.AuthDB.ip_whitelists',
            index=4,
            number=6,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='ip_whitelist_assignments',
            full_name='components.auth.AuthDB.ip_whitelist_assignments',
            index=5,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.AuthDB.token_server_url',
            index=6,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.AuthDB.security_config',
            index=7,
            number=9,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='realms',
            full_name='components.auth.AuthDB.realms',
            index=8,
            number=11,
            type=11,
            cpp_type=10,
...
_AUTHDBREVISION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='primary_id',
            full_name='components.auth.AuthDBRevision.primary_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='auth_db_rev',
            full_name='components.auth.AuthDBRevision.auth_db_rev',
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='modified_ts',
            full_name='components.auth.AuthDBRevision.modified_ts',
            index=2,
            number=3,
            type=3,
            cpp_type=2,
...
_SIGNEDAUTHDB = _descriptor.Descriptor(
    name='SignedAuthDB',
    full_name='components.auth.SignedAuthDB',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name='auth_db_blob',
            full_name='components.auth.SignedAuthDB.auth_db_blob',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signer_id',
            full_name='components.auth.SignedAuthDB.signer_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signing_key_id',
            full_name='components.auth.SignedAuthDB.signing_key_id',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signature',
            full_name='components.auth.SignedAuthDB.signature',
            index=3,
            number=4,
            type=12,
            cpp_type=9,
...
_CHANGENOTIFICATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='revision',
            full_name='components.auth.ChangeNotification.revision',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_REPLICATIONPUSHREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='revision',
            full_name='components.auth.ReplicationPushRequest.revision',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='auth_db',
            full_name='components.auth.ReplicationPushRequest.auth_db',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='auth_code_version',
            full_name='components.auth.ReplicationPushRequest.auth_code_version',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_REPLICATIONPUSHRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.ReplicationPushResponse.current_revision',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='error_code',
            full_name='components.auth.ReplicationPushResponse.error_code',
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name='auth_code_version',
            full_name=
            'components.auth.ReplicationPushResponse.auth_code_version',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_SERVICELINKRESPONSE.fields_by_name[
    'status'].enum_type = _SERVICELINKRESPONSE_STATUS
...
_AUTHDB.fields_by_name[
    'ip_whitelist_assignments'].message_type = _AUTHIPWHITELISTASSIGNMENT
_AUTHDB.fields_by_name[
    'realms'].message_type = components_dot_auth_dot_proto_dot_realms__pb2._REALMS
_CHANGENOTIFICATION.fields_by_name['revision'].message_type = _AUTHDBREVISION
_REPLICATIONPUSHREQUEST.fields_by_name[
    'revision'].message_type = _AUTHDBREVISION
_REPLICATIONPUSHREQUEST.fields_by_name['auth_db'].message_type = _AUTHDB
_REPLICATIONPUSHRESPONSE.fields_by_name[
    'status'].enum_type = _REPLICATIONPUSHRESPONSE_STATUS
_REPLICATIONPUSHRESPONSE.fields_by_name[
    'current_revision'].message_type = _AUTHDBREVISION
_REPLICATIONPUSHRESPONSE.fields_by_name[
    'error_code'].enum_type = _REPLICATIONPUSHRESPONSE_ERRORCODE
...
DESCRIPTOR.message_types_by_name[
    'AuthIPWhitelistAssignment'] = _AUTHIPWHITELISTASSIGNMENT
...
DESCRIPTOR.message_types_by_name[
    'ReplicationPushRequest'] = _REPLICATIONPUSHREQUEST
DESCRIPTOR.message_types_by_name[
    'ReplicationPushResponse'] = _REPLICATIONPUSHRESPONSE
_sym_db.RegisterFileDescriptor(DESCRIPTOR)

ServiceLinkTicket = _reflection.GeneratedProtocolMessageType(
    'ServiceLinkTicket',
    (_message.Message,),
    dict(
...
ServiceLinkRequest = _reflection.GeneratedProtocolMessageType(
    'ServiceLinkRequest',
    (_message.Message,),
    dict(
...
ServiceLinkResponse = _reflection.GeneratedProtocolMessageType(
    'ServiceLinkResponse',
    (_message.Message,),
    dict(
...
AuthGroup = _reflection.GeneratedProtocolMessageType(
    'AuthGroup',
    (_message.Message,),
    dict(
...
AuthIPWhitelist = _reflection.GeneratedProtocolMessageType(
    'AuthIPWhitelist',
    (_message.Message,),
    dict(
...
AuthIPWhitelistAssignment = _reflection.GeneratedProtocolMessageType(
...
AuthDB = _reflection.GeneratedProtocolMessageType(
    'AuthDB',
    (_message.Message,),
    dict(
        DESCRIPTOR=_AUTHDB,
...
AuthDBRevision = _reflection.GeneratedProtocolMessageType(
    'AuthDBRevision',
    (_message.Message,),
    dict(
...
SignedAuthDB = _reflection.GeneratedProtocolMessageType(
    'SignedAuthDB',
    (_message.Message,),
    dict(
        DESCRIPTOR=_SIGNEDAUTHDB,
        __module__='components.auth.proto.replication_pb2'
        # @@protoc_insertion_point(class_scope:components.auth.SignedAuthDB)
    ))
_sym_db.RegisterMessage(SignedAuthDB)

ChangeNotification = _reflection.GeneratedProtocolMessageType(
    'ChangeNotification',
    (_message.Message,),
    dict(
...
ReplicationPushRequest = _reflection.GeneratedProtocolMessageType(
...
ReplicationPushResponse = _reflection.GeneratedProtocolMessageType(
