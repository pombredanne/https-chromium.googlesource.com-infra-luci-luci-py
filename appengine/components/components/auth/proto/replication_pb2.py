...
from components.auth.proto import buckets_pb2 as components_dot_auth_dot_proto_dot_buckets__pb2
...
_AUTHDB.fields_by_name['buckets'].message_type = components_dot_auth_dot_proto_dot_buckets__pb2._BUCKET
