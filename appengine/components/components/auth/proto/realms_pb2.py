...
_REALMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='api_version',
            full_name='components.auth.realms.Realms.api_version',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name='permissions',
            full_name='components.auth.realms.Realms.permissions',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='realms',
            full_name='components.auth.realms.Realms.realms',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PERMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='components.auth.realms.Permission.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_REALM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='components.auth.realms.Realm.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='bindings',
            full_name='components.auth.realms.Realm.bindings',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_BINDING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='permissions',
            full_name='components.auth.realms.Binding.permissions',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='principals',
            full_name='components.auth.realms.Binding.principals',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
Realms = _reflection.GeneratedProtocolMessageType(
    'Realms',
    (_message.Message,),
    dict(
        DESCRIPTOR=_REALMS,
