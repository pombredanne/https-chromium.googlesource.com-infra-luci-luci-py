...
_PERMISSIONSLIST = _descriptor.Descriptor(
  ...
  full_name='auth.service.permissions.PermissionsList',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='permissions', full_name='auth.service.permissions.PermissionsList.permissions', index=0,
...
PermissionsList = _reflection.GeneratedProtocolMessageType('PermissionsList', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:auth.service.permissions.PermissionsList)
  })
