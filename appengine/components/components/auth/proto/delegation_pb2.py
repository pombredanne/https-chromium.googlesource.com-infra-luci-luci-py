...
_DELEGATIONTOKEN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='signer_id',
            full_name='components.auth.DelegationToken.signer_id',
            index=0,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='signing_key_id',
            full_name='components.auth.DelegationToken.signing_key_id',
            index=1,
            number=3,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='pkcs1_sha256_sig',
            full_name='components.auth.DelegationToken.pkcs1_sha256_sig',
            index=2,
            number=4,
            type=12,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='serialized_subtoken',
            full_name='components.auth.DelegationToken.serialized_subtoken',
            index=3,
            number=5,
            type=12,
            cpp_type=9,
...
_SUBTOKEN = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='subtoken_id',
            full_name='components.auth.Subtoken.subtoken_id',
            index=1,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.Subtoken.delegated_identity',
            index=2,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.Subtoken.requestor_identity',
            index=3,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='creation_time',
            full_name='components.auth.Subtoken.creation_time',
            index=4,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='components.auth.Subtoken.validity_duration',
            index=5,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='audience',
            full_name='components.auth.Subtoken.audience',
            index=6,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='services',
            full_name='components.auth.Subtoken.services',
            index=7,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='tags',
            full_name='components.auth.Subtoken.tags',
            index=8,
            number=9,
            type=9,
            cpp_type=9,
...
DelegationToken = _reflection.GeneratedProtocolMessageType(
    'DelegationToken',
    (_message.Message,),
    dict(
...
Subtoken = _reflection.GeneratedProtocolMessageType(
    'Subtoken',
    (_message.Message,),
    dict(
