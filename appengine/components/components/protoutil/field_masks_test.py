...
class ParsePathTests(unittest.TestCase):
  ...
  def test_json_name(self):
    actual = self.parse('mapStrNum.aB', from_json_names=True)
    expected = ('map_str_num', 'aB')
    self.assertEqual(actual, expected)

  def test_json_name_option(self):
    actual = self.parse('another_json_name', from_json_names=True)
...
class FromFieldMaskTests(unittest.TestCase):
  ...
  def test_json_names(self):
    actual = self.parse(['mapStrNum.aB', 'str'], from_json_names=True)
