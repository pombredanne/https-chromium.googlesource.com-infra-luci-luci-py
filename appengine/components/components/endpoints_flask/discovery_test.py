  ...
  def test_generate(self):
    ...
    expected = {
        ...
        'parameters': {
            ...
            'key': {
                'description':
                ('API key. Your API key identifies your project and provides'
                 ' you API access, quota, and reports. Required unless you'
            ...
            'userIp': {
                'description':
                ('IP address of the site where the request originates. Use'
