...
SplitService = endpoints.api('split',
                             'v1',
...
class DiscoveryWebapp2TestCase(test_case.TestCase):
  ...
  def test_get_parameters(self):
    ...
    self.assertEqual(
        discovery._get_parameters(Message,
                                  'path/{boolean}/with/{string}/parameters'),
        expected)
  ...
  def test_generate(self):
    ...
    expected = {
        ...
        'parameters': {
            ...
            'key': {
                'description':
                ('API key. Your API key identifies your project + gives you'
                 ' API access, quota, and reports. Required unless you'
            ...
            'quotaUser': {
                ...
                ('Available to use for quota purposes for server-side'
                 ...
                 ' but cannot exceed 40 characters. Overrides userIp if both'
                 ' are provided.'),
                'location':
                'query',
                'type':
    ...
    self.assertEqual(discovery.generate([Service], 'localhost:8080', '/api'),
                     expected)
    expected = {
        'auth': {
            'oauth2': {
        ...
        'parameters': {
            ...
            'key': {
                'description':
                ('API key. Your API key identifies your project + provides you'
            ...
            'quotaUser': {
                'description':
                ('Available to use for quota purposes for server-side'
                 ' apps. Can be any arbitrary string assigned to a user,'
                 ' but shouldn`t exceed 40 characters. Overrides userIp if both'
                 ' are provided.'),
                'location':
                'query',
                'type':
