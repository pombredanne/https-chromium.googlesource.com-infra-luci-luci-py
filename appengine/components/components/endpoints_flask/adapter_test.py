...
class EndpointsFlaskTestCase(test_case.TestCase):
  ...
  def test_api_routes(self):
    routes = sorted([
        r[0]
        for r in adapter.api_routes([EndpointsService], base_path='/_ah/api')
    ])
    self.assertEqual(
        routes,
        [
            ...
            '/_ah/api/Service/v1/get/options',
            '/_ah/api/Service/v1/get_container',
            '/_ah/api/Service/v1/get_container/options',
            '/_ah/api/Service/v1/post',
            '/_ah/api/Service/v1/post/options',
            '/_ah/api/Service/v1/post_403',
            '/_ah/api/Service/v1/post_403/options',
