...
class CalculateVersionTest(unittest.TestCase):
  ...
  def test_pristine_version(self):
    actual = calculate_version._get_limited_version('1234', '123abcd', True,
                                                    'auser', '', 63)
  ...
  def test_non_pristine_version(self):
    actual = calculate_version._get_limited_version('1234', '123abcd', False,
                                                    'auser', '', 63)
  ...
  def test_truncate_long_username(self):
    actual = calculate_version._get_limited_version('12345', '123abcd', False,
                                                    'alongusername', '', 20)
  ...
  def test_raise_on_truncate_username_to_less_than_six_chars(self):
    actual = calculate_version._get_limited_version('123456', '123abc', False,
                                                    'along-username', '', 20)
