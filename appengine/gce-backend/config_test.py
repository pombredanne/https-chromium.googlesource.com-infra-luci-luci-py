...
class UpdateConfigTest(test_case.TestCase):
  ...
  def test_valid_guest_accelerator_type_with_colon_accepted(self):
    template_config = config_pb2.InstanceTemplateConfig(
        templates=[
            config_pb2.InstanceTemplateConfig.InstanceTemplate(
                guest_accelerators=['accelerator:type-1:2'],
  ...
  def test_guest_accelerator_no_count_rejected(self):
    template_config = config_pb2.InstanceTemplateConfig(
        templates=[
            config_pb2.InstanceTemplateConfig.InstanceTemplate(
                guest_accelerators=['accelerator-type-1'],
  ...
  def test_guest_accelerator_no_type_rejected(self):
    template_config = config_pb2.InstanceTemplateConfig(
        templates=[
            config_pb2.InstanceTemplateConfig.InstanceTemplate(
                guest_accelerators=[':2'],
            ),
        ],
    )
    self.install_mock(template_config=template_config)
  ...
  def test_too_many_guest_accelerator_types_rejected(self):
    template_config = config_pb2.InstanceTemplateConfig(
        templates=[
            config_pb2.InstanceTemplateConfig.InstanceTemplate(
                guest_accelerators=[
                    'accelerator-type-1:2',
                    'accelerator-type-2:2',
                    'accelerator-type-3:2',
                    'accelerator-type-4:2',
                    'accelerator-type-5:2',
                    'accelerator-type-6:2',
                    'accelerator-type-7:2',
                    'accelerator-type-8:2',
                    'accelerator-type-9:2',
                    'accelerator-type-10:2',
                    'accelerator-type-11:2',
                ],
            ),
        ],
    )
