...
class RolesExpansionTest(test_case.TestCase):
  def test_builtin_roles(self):
    r = rules.RolesExpansion(test_db(), [])
...
class ExpandRealmsTest(test_case.TestCase):
  def expand(self, cfg):
    ...
    self.assertEqual(out.api_version, model.REALMS_API_VERSION)
    out.ClearField('api_version')
