...
_REALMSCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='realms',
            full_name='auth_service.RealmsCfg.realms',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='custom_roles',
            full_name='auth_service.RealmsCfg.custom_roles',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_REALM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='auth_service.Realm.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='extends',
            full_name='auth_service.Realm.extends',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='bindings',
            full_name='auth_service.Realm.bindings',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_BINDING = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='role',
            full_name='auth_service.Binding.role',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='principals',
            full_name='auth_service.Binding.principals',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CUSTOMROLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='name',
            full_name='auth_service.CustomRole.name',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='extends',
            full_name='auth_service.CustomRole.extends',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='permissions',
            full_name='auth_service.CustomRole.permissions',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
RealmsCfg = _reflection.GeneratedProtocolMessageType(
    'RealmsCfg',
    (_message.Message,),
    dict(
