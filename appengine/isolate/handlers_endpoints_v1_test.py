...
class IsolateServiceTest(test_case.EndpointsTestCase):
  ...
  def _round_trip(self, namespace, algo, is_compressed):
    ...
    actual = base64.b64decode(
        self.call_api(
            'retrieve', self.message_to_dict(request), 200).json['content'])
