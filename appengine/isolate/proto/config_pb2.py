...
_SETTINGSCFG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='SettingsCfg.google_analytics',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='SettingsCfg.default_expiration',
            index=1,
            number=2,
            type=5,
            cpp_type=1,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='sharding_letters',
            full_name='SettingsCfg.sharding_letters',
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name='gs_bucket',
            full_name='SettingsCfg.gs_bucket',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='gs_client_id_email',
            full_name='SettingsCfg.gs_client_id_email',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='SettingsCfg.enable_ts_monitoring',
            index=5,
            number=6,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name='ui_client_id',
            full_name='SettingsCfg.ui_client_id',
            index=7,
            number=8,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='client_monitoring_config',
            full_name='SettingsCfg.client_monitoring_config',
            index=8,
            number=9,
            type=11,
            cpp_type=10,
...
_AUTHSETTINGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='AuthSettings.full_access_group',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='readonly_access_group',
            full_name='AuthSettings.readonly_access_group',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_CLIENTMONITORINGCONFIG = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='ip_whitelist',
            full_name='ClientMonitoringConfig.ip_whitelist',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='label',
            full_name='ClientMonitoringConfig.label',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_SETTINGSCFG.fields_by_name[
    'client_monitoring_config'].message_type = _CLIENTMONITORINGCONFIG
...
DESCRIPTOR.message_types_by_name[
    'ClientMonitoringConfig'] = _CLIENTMONITORINGCONFIG
...
ClientMonitoringConfig = _reflection.GeneratedProtocolMessageType(
