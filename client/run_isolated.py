...
def _fetch_and_map(cas_client, digest, instance, output_dir, cache_dir,
  ...
  try:
    ...
    def open_json_and_check(result_json_path, cleanup_dirs):
      ...
      if cas_error:
        raise errors.NonRetriableCasException(result_json['result'], digest,
                                              instance)
      return result_json
...
def map_and_run(data, constant_run_path):
  ...
  except errors.NonRetriableCasException as e:
  ...
  except errors.NonRetriableCipdException as e:
...
def main(args):
  ...
  try:
    return run_tha_test(data, options.json)
          ...
          errors.NonRetriableCipdException) as ex:
