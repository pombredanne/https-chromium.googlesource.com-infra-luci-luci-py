...
run_isolated takes cares of setting up a temporary environment, run a command,
and tear it down.

It can handle isolated files, mapping CIPD packages and reusing stateful named
caches.
