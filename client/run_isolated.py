...
def fetch_and_map(isolated_hash, storage, cache, outdir, use_symlinks,
  ...
  if (fs.isfile(isolated_client) and
      # TODO(crbug.com/932396): Use below condition temporarily to decide
      # whether we use go client or not.
      os.path.basename(cache.cashe_dir).startswith('go_')):
