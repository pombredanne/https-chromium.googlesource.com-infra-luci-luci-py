...
ISOLATED_REVISION = 'git_revision:0b6932af7d7df8ddbb3f04ac2db29a236fed0c50'
    ...
    with tools.Profiler('ArchiveOutput'):
      try:
        results, f_cold, f_hot = isolateserver.archive_files_to_storage(
            ...
            [out_dir],
            None,
            # Windows doesn't have issue like crbug.com/1073832, but has
            # crbug.com/1076637.
            # TODO(crbug.com/1076637): make this True if we fixed the root
            # cause.
            verify_push=sys.platform != 'win32')
        outputs_ref = {
