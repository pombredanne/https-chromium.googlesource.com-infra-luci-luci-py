...
class NonRetriableException(Exception):
  """For handling errors where we should not attempt to retry"""
  ...
  def to_dict(self):
    """Returns a dictionary with the attributes serialised into a dictionary"""
    raise NotImplementedError()

  def name(self):
    """Returns the shortened exception name"""
    raise NotImplementedError()


class NonRetriableCasException(NonRetriableException):
  ...
  def __init__(self, status, digest, instance):
    ...
    super(NonRetriableCasException, self).__init__(
        status, "CAS digest {} on instance {}".format(digest, instance))
...
class NonRetriableCipdException(NonRetriableException):
  ...
  def __init__(self, status, package_name, path, version):
    ...
    super(NonRetriableCipdException, self).__init__(
        status, "Bad CIPD package {} with version {} on path {}".format(
