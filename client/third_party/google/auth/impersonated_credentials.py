...
class IDTokenCredentials(credentials.Credentials):
    ...
    def from_credentials(self, target_credentials, # pylint: disable=unused-argument
    ...
    def refresh(self, request): # pylint: disable=unused-argument
        ...
        self.token = id_token # pylint: disable=attribute-defined-outside-init
        self.expiry = datetime.fromtimestamp(jwt.decode(id_token, # pylint: disable=attribute-defined-outside-init
                                             verify=False)['exp'])
