...
class StreamClient(object):
  ...
  class _TextStream(_BasicStream):
    """Extends _BasicStream, ensuring data written is text."""
    ...
    def write(self, data):
      if _PY2 and isinstance(data, str):
        ...
        # undifferentiated usage `str` and `unicode` but it should be
        # discontinued in py3 for text stream. User should switch to
        # binary stream instead if there's a need to write bytes.
        return self._fd.write(data)
