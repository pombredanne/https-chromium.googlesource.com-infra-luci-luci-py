...
class DiskContentAddressedCacheTest(TestCase, ContentAddressedCacheTestMixin):
  ...
  def test_write_policies_min_free_space(self):
    ...
    expected = (
        ...
        'CachePolicies(max_cache_size=0 (0.0 GiB); max_items=0; '
        'min_free_space=1000 (9.31322574615e-07 GiB); max_age_secs=0)\n  '
        'cache=8 bytes (7.45058059692e-09 GiB), 4 items; '
        '999 bytes (9.30391252041e-07 GiB) free_space')
