...
class RunIsolatedTest(unittest.TestCase):
  ...
  def _upload_to_cas(self, upload_dir):
    ...
    cas_digest = read_content(digest_file).decode()
  ...
  def test_cas_output(self):
    ...
    # TODO(jwata): Initial upload should be reported in `items_cold`.
    # But the file is already there since we use the same remote instance.
