...
class TestCase(net_utils.TestCase):
  def test_get_hash_algo(self):
    ...
    self.assertIs(isolated_format.get_hash_algo('default-gzip'),
                  hashlib.sha1)
    self.assertIs(isolated_format.get_hash_algo('default-sha-1'),
                  hashlib.sha1)
    self.assertIs(isolated_format.get_hash_algo('default-sha-1-gzip'),
                  hashlib.sha1)
    self.assertIs(isolated_format.get_hash_algo('default-sha-256'),
                  hashlib.sha256)
    self.assertIs(isolated_format.get_hash_algo('default-sha-256-gzip'),
                  hashlib.sha256)
    self.assertIs(isolated_format.get_hash_algo('default-sha-512'),
                  hashlib.sha512)
    self.assertIs(isolated_format.get_hash_algo('default-sha-512-gzip'),
                  hashlib.sha512)
