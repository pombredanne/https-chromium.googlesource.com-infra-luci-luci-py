...
class RunIsolatedTestOutputs(RunIsolatedTestBase):
  ...
  def create_src_tree(self, run_dir, src_dir):
    ...
    for path in src_dir:
      ...
      if t == Type.FILE:
        ...
        # Assume link destinations always have the path relative to root.
  ...
  def link_outputs(self, src_dir, outputs):
  ...
  def test_symlink_to_symlink_to_file(self):
    src_dir = {
        'first_link': (Type.LINK, 'second_link'),
        'second_link': (Type.LINK, 'foo_file'),
        'foo_file': (Type.FILE, 'contents of foo'),
    }
    outputs = ['first_link']
    expected = {
  ...
  def test_symlink_to_symlink_to_nonexistenet_file(self):
    src_dir = {
        'first_link': (Type.LINK, 'second_link'),
        'second_link': (Type.LINK, 'nonexistent_file'),
    }
    outputs = ['first_link']
    expected = {}
    out_dir = self.link_outputs(src_dir, outputs)
  ...
  def test_symlink_to_file_in_parent(self):
    src_dir = {
        'subdir': (Type.DIR, {
            'subsubdir': (Type.DIR, {
                'foo_link': (Type.LINK, 'subdir/foo_file'),
            }),
            'foo_file': (Type.FILE, 'contents of foo'),
        }),
    }
    outputs = ['subdir/subsubdir/foo_link']
    expected = {
  ...
  #def test_symlink_to_parent_dir(self):
  #  src_dir = {
  #      'subdir': (Type.DIR, {
  #          'subsubdir': (Type.DIR, {
  #              'subdir_link': (Type.LINK, 'subdir'),
  ...
  #      }),
  #  }
  #  outputs = ['subdir/subsubdir/subdir_link']
  #  expected = {
  #      'subdir/subsubdir': '',
  #  }
  #  out_dir = self.link_outputs(src_dir, outputs)
  ...
  def test_symlink_to_symlink_to_file_in_dir(self):
    src_dir = {
        'first_link': (Type.LINK, 'subdir_link'),
        'subdir_link': (Type.LINK, 'subdir/child_a'),
        'subdir': (Type.DIR, {
            'child_a': (Type.FILE, 'contents of a'),
        }),
