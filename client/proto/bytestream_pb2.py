...
_QUERYWRITESTATUSRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='committed_size',
            full_name=
            'google.bytestream.QueryWriteStatusResponse.committed_size',
            index=0,
            number=1,
            type=3,
            cpp_type=2,
...
DESCRIPTOR.message_types_by_name[
    'QueryWriteStatusRequest'] = _QUERYWRITESTATUSREQUEST
DESCRIPTOR.message_types_by_name[
    'QueryWriteStatusResponse'] = _QUERYWRITESTATUSRESPONSE
