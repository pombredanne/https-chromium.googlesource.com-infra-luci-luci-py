...
from utils.logging_utils import USER_LOGS
...
def trim_caches(caches, path, min_free_space, max_age_secs):
  ...
  logging.log(USER_LOGS,
              "Trimming caches. min_ts: %d, free_disk: %d, min_free_space: %d",
  ...
  for c in caches:
    logging.log(USER_LOGS, "trimming cache with dir %s", c.cache_dir)
    total.extend(c.trim())
  return total
