...
def putfile(srcfileobj, dstpath, file_mode=None, size=-1, use_symlink=False):
  ...
  if srcpath and size == -1:
    ...
    if sys.platform == 'win32' and file_mode and (
        file_mode & stat.S_IWRITE) != 0:
      # On windows, mode other than stat.S_IWRITE is ignored. Returns early to
      # skip slow/unnecessary chmod call.
      return
