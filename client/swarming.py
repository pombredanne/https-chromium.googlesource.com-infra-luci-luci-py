...
def CMDreproduce(parser, args):
  ...
  if (properties.get('inputs_ref') or {}).get('isolated'):
    ...
    with isolateserver.get_storage(
      ...
      # Do not use MemoryContentAddressedCache here, as on python 32 bits,
      # inputs larger than ~1Gb will not fit in memory. This is effectively a
      # leak.
      ...
      cache = local_caching.DiskContentAddressedCache(
          options.cache, policies, algo, False)
