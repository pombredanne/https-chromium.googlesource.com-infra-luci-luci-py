...
def make_tree_deleteable_with_scandir_win(root):
  logging.debug('file_path.make_tree_deleteable_with_scandir_win(%s)', root)
  err = None
...
def make_tree_deleteable_with_scandir_posix(root):
  logging.debug('file_path.make_tree_deleteable_with_scandir_posix(%s)', root)
  err = None
  sudo_failed = False
