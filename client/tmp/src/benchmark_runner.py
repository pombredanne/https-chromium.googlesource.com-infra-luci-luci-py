...
def main():
  ...
  subprocess.check_output(['vpython3' + CMDSUFFFIX, '-vpython-spec', vpython_spec, SCRIPT, dir1])
  ...
  subprocess.check_output(['vpython' + CMDSUFFFIX, '-vpython-spec', vpython_spec,  SCRIPT, dir2])
